...
public class SuggestStandards extends CATWebService {
	...
	/**
	 * Constructor for the SuggestStandards object supplying username, password and
	 * baseUrl
	 *
	 * @param username
	 *            the client username
	...
	/**
	 * @param resourceUrl
	 *            url for resource for which suggestions are made
	 * @param optionalArgs
	 *            additional search contraints
	...
	/**
	 * Extracts the resultIds from a list of CATStandard instances created from CAT
	 * response
	 *
	 * @param results
	 *            list of CATStandards
