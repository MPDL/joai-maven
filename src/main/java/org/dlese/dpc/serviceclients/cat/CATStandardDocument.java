...
public class CATStandardDocument {
	...
	/**
	 * Utility to get the text of the child element specified by "tag" or a default
	 * value if the element is not found (rather than throwing an Exception)
	 *
	 * @param tag
	 *            child element tag
	 * @param defaultValue
	 *            the default value
	 * @return The text of the child element, or default if child is not found
	 */
