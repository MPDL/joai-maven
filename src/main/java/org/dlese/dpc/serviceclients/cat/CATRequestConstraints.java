...
public class CATRequestConstraints {
	...
	/**
	 * Gets the standardDocuments attribute of the CATRequestConstraints object by
	 * creating a comma-delimited string joining the items in the standardDocuments
	 * list
	 *
	 ...
	 *
	 * @param docId
	 *            asn docId to be added to standardDocuments
	 */
	 ...
	 *
	 * @param q
	 *            The new query value (used to specifiy resourceUrl)
	 */
	 ...
	 *
	 * @param stds
	 *            The new feedbackStandards value
	 */
