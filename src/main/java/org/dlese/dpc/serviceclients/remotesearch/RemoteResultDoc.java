 ...
 * {@link RemoteSearcher#searchDocs(String)}. It is patterned after the
 * {@link org.dlese.dpc.index.ResultDoc} class.
 *
 * @author ostwald
 */
public class RemoteResultDoc implements java.io.Serializable {
	...
	/**
	 * Constructor for the RemoteResultDoc object. Used to create a RemoteResultDoc
	 * from an <b>alsoCatalogedBy</b> element (see
	 * {@link RemoteSearcher#searchDocs})
	 *
	 * @param id
	 *            id of item
	 * @param url
	 *            url of item
	 * @param collection
	 *            collection label of item
	 * @param rs
	 *            instance of {@link RemoteSearcher}
	 */
	 ...
	 *
	 * @param record
	 *            matching record {@link org.dom4j.Element}
	 * @param rs
	 *            instance of {@link RemoteSearcher}
	 */
	...
	/**
	 * Gets the id attribute of the RemoteResultDoc object (identifying the resource
	 * within DDS)
	 *
	 * @return The id value
	 */
	 ...
	 * display of RemoteResultDoc instances via JSP (see {@link ADNItemDocReader}).
	 *
	...
	/**
	 * Gets the document attribute of the RemoteResultDoc object. The doc attribute
	 * is obtained from the {@link RemoteSearcher} instance and then cached for
	 * future access.
	 *
