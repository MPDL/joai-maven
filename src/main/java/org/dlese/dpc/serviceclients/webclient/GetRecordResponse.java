...
/**
 * GetRecordResponse class wraps the response from the
 * <a href="http://swiki.dpc.ucar.edu/Project-Discovery/108#GetRecord">GetRecord
...
public class GetRecordResponse {
	 ...
	 * {@link org.dom4j.Document} representation of the GetRecord Service response.
	 *
	...
	/**
	 * Gets the itemRecord attribute of the GetRecordResponse class. The itemRecord
	 * is the ADN item-level record contained in the GetRecord Service Response.
	 *
