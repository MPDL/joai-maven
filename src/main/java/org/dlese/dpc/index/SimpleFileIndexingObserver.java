...
/**
 * 
 * A FileIndexingObserver that simply outputs messages to System out. Can be
 * turned off by calling the static debug(false) method.
 *
 * 
 * 
...
public class SimpleFileIndexingObserver implements FileIndexingObserver {
	 ...
	 *            A message that gets is sent to System out when this Object is
	 *            created.
	 * 
	 */
	 ...
	 * 
	 * @param messagePrefix
	 *            A identifier String that is inserted at the beginning of all
	 *            messages output by
	 * 
	 *            this SimpleFileIndexingObserver
	 * 
	 * @param startUpMessage
	 *            A message that gets is set to System out when this Object is
	 *            created.
	 * 
	 */
