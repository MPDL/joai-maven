...
/**
 * 
 * This interface is used by Objects wishing to determine when a background
 * intexing process has completed
 * 
...
public interface FileIndexingObserver {
	...
	/**
	 * 
	 * This method is called when the indexing is complete. This method may then do
	 * additional processing that
	 * 
	 * is required after indexing and will execute within the same indexing thread,
	 * thus blocking all other
	 * 
	 ...
	 * 
	 * @param status
	 *            The status code upon completion
	 * 
	 * @param message
