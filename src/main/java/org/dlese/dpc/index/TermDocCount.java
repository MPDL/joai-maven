 ...
 * {@link SimpleLuceneIndex#getTermAndDocCounts(String[])} and contains the term
 * count, the total number of documents containing the term and a list of fields
...
public class TermDocCount {
	 ...
	 *
	 * @param add
	 *            The feature to be added to the ToTermCount attribute
	 */
	 ...
	 *
	 * @param add
	 *            The feature to be added to the ToDocCount attribute
	 */
	...
	/**
	 * Compares two TermDocCount by the term count. Collections.sort() or
	 * Arrays.sort() can thus be used to sort a list of TermDocCount by Name.
	 *
	 * @param o
