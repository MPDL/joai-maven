 ...
 * {@link org.dlese.dpc.index.SimpleLuceneIndex} search. This factory uses the
 * class name provided in the
 * {@link org.dlese.dpc.index.writer.DocWriter#getReaderClass()} method to
 * return the {@link org.dlese.dpc.index.reader.DocReader} bean that is best
 * suited to read the type of index {@link org.apache.lucene.document.Document}
 * that was returned by the search. Also provides access to a
 * {@link org.dlese.dpc.index.reader.DocumentMap} for reading the fields in the
 * lucene Document. This container also provides acces to the
 * {@link org.apache.lucene.document.Document}, the score rank and the document
 * number.
 * <p>
 *
 * Example that uses JSTL inside a JSP page (assumes result is an instance of
 * ResultDoc and that the DocReader has a method named getFormattedDate()):
 * <p>
 *
 * <code>
...
public class ResultDoc implements Comparable, Serializable {
	...
	/**
	 * Gets the {@link org.dlese.dpc.index.reader.DocReader} used to read the
	 * specific {@link org.apache.lucene.document.Document} type that is returned in
	 * a search. Remember that all concrete DocReader classes must have a default
	...
	/**
	 * Gets a {@link org.dlese.dpc.index.reader.DocumentMap} of all field/values
	 * contained in the Lucene {@link org.apache.lucene.document.Document}. The text
	 * values in each field is stored in the Map as Strings. For example
	 * getDocMap.get("title") returns the text that was indexed and stored under the
	 * field name "title" for this Document.
	 * <p>
	 *
	 * Example that uses JSTL inside a JSP page (assumes result is an instance of
	 * ResultDoc):
	...
	/**
	 * Gets a {@link org.dlese.dpc.index.reader.LazyDocumentMap} of all field/values
	 * contained in the Lucene {@link org.apache.lucene.document.Document}. The text
	 * values in each field is stored in the Map as Strings. For example
	 * getDocMap.get("title") returns the text that was indexed and stored under the
	 * field name "title" for this Document.
	...
	/**
	 * Gets the doctype for this ResultDoc. Assumes there is a stored field in the
	 * Lucene document named 'doctype' that contains the docytype name such as
	 * "dlese_ims" or "adn."
	 *
	 ...
	 * {@link org.dlese.dpc.index.SimpleLuceneIndex} class during search result hit
	 * list compilation to create a {@link ResultDocCollection}.
	 *
	 * @param c
	 *            The configuration for this ResultDoc
	 * @param dn
	 *            The Lucene document number for the
	 *            {@link org.apache.lucene.document.Document} associated with this
	 *            ResultDoc.
	 * @param s
	 *            The rank assigned to this result by the Lucene search engine.
	 */
	 ...
	 *
	 * @param d
	 *            A Lucene {@link org.apache.lucene.document.Document} used to
	 *            populate this ResultDoc.
	 * @param c
	 *            The configuration for this ResultDoc
	 */
	...
	/**
	 * Constructs a ResultDoc using the {@link org.apache.lucene.document.Document}
	 * provided. Use this constructor to wrap a
	 * {@link org.apache.lucene.document.Document} inside a ResultDoc.
	 *
	 * @param doc
	 *            A Lucene {@link org.apache.lucene.document.Document} used to
	 *            populate this ResultDoc.
	...
	/**
	 * Gets the Lucene {@link org.apache.lucene.document.Document} associated with
	 * this ResultDoc. If the index has changed since the search was conducted, this
	 * method may return an empty or incorrect Document. It is therefore best to
	 * read all Documents as soon as possible after a search if the index is being
	 * concurrently modified.
	 *
	 * @return The {@link org.apache.lucene.document.Document} associated with this
	 *         ResultDoc.
	 */
	...
	/**
	 * Gets the field content used by {@link LuceneFieldComparator} for sorting.
	 * Note that it is not possible to re-sort a single set of ResultDocs. To
	 * re-sort, first do a fresh search, then a fresh sort over the new ResultDocs
	 * using the differnt field.
	 *
	 * @param field
	 *            The field name used for sorting
	 * @return The given field content
	 * @see LuceneFieldComparator
	 * @deprecated Sorting should now be done by supplying a
	 *             {@link org.apache.lucene.search.Sort} object at search time.
	 *             Sorting on returned ResultDocs is less efficient and may cause
	 *             OutOfMemory errors on large result sets.
	 */
	 ...
	 * {@link SimpleLuceneIndex#setAttribute(String,Object)}.
	 *
	 * @param key
