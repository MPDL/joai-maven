 ...
 * {@link org.apache.lucene.document.Document} from any valid XML file by
 * stripping the XML tags to extract and index the content. The full content of
 * all Elements and Attributes is indexed in the default and admindefault fields
 * and is stemmed and indexed in the stems field. The reader for this type of
...
public class SimpleXMLFileIndexingWriter extends XMLFileIndexingWriter {
	...
	/**
	 * Gets the xml format for this document, for example "oai_dc," "adn,"
	 * "dlese_ims," or "dlese_anno".
	 *
	 ...
	 * null if no error was found. This method performs schema validation over the
	 * XML.
	 *
	...
	protected void addFields(org.apache.lucene.document.Document newDoc,
			org.apache.lucene.document.Document existingDoc, File sourceFile) throws Exception {
