...
/**
 * Factory used to create the XmlFileIndexingWriter appropriate for handling a
 * given XML format.
 *
...
public class XMLFileIndexingWriterFactory {
	...
	private final static Object[][] INDEXING_WRITER_CLASSES = {
			{"default_handler_class", SimpleXMLFileIndexingWriter.class}, {"adn", ADNFileIndexingWriter.class},
			{"dlese_ims", DleseIMSFileIndexingWriter.class}, {"dlese_anno", DleseAnnoFileIndexingServiceWriter.class},
			{"dlese_collect", DleseCollectionFileIndexingWriter.class}, {"news_opps", NewsOppsFileIndexingWriter.class},
	...
	/**
	 * Adds additional classes of XMLFileIndexingWriters Key are the xmlformat,
	 * value the Class
	 * 
	 * @param ht
	 */
	 ...
	 *
	 * @param rds
	 *            The RecordDataService being used, or null if none needed.
	 * @param simpleLuceneIndex
	 *            The index being used
	 * @param additionalIndexers
	 */
	public XMLFileIndexingWriterFactory(RecordDataService rds, SimpleLuceneIndex simpleLuceneIndex,
			XMLIndexerFieldsConfig xmlIndexerFieldsConfig, Hashtable additionalIndexers) {
		index = simpleLuceneIndex;
	 ...
	 *
	 * @param collection
	 *            The collection key, for example dcc, comet, etc.
	 * @param xmlFormat
	 *            The xml format specifier, for example adn, news_opps,
	 *            dlese_collect.
	...
	public XMLFileIndexingWriter getIndexingWriter(String collection, String xmlFormat) throws Exception {
		...
		/*
		 * else System.out.println("xmlIndexerFieldsConfig is null!");
		 */
