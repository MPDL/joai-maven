 ...
 * {@link org.apache.lucene.document.Document}. A {@link
 * 
...
public interface DocWriter {
	...
	/**
	 * 
	 * Returns a unique document type key for this kind of document, corresponding
	 * to the format type. For
	 * 
	 * example "dleseims". The string is parsed using the Lucene {@link
	 * 
	 * org.apache.lucene.analysis.standard.StandardAnalyzer} so it must be lowercase
	 ...
	 * 
	 * "org.dlese.dpc.index.reader.ItemDocReader". The class name is used by the
	 * {@link
	 * 
