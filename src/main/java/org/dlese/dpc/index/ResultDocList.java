...
public class ResultDocList extends AbstractList {
	...
	/**
	 * Creates a ResultDocList backed by the given resultDocs that can not be
	 * expanded.
	 *
	 * @param resultDocs
	 *            The result docs that back this ResultDocList.
	 */
	...
	/**
	 * Creates a ResultDocList backed by the given search results that can not be
	 * expanded. Constructed by SimpleLuceneIndex when a search is made.
	 *
	 * @param topDocs
	 *            The TopDocs
	 * @param resultDocConfig
	 *            The config
	 */
	...
	public ResultDoc get(int i) {
		...
		if (i < 0 || i >= size())
			throw new IndexOutOfBoundsException(
					"Index " + i + " is out of bounds. Must be greater than or equal to 0 and less than " + size());
	...
	/**
	 * Gets the ResultDocs as an array. Note that this is significantly less
	 * efficient than using the List methods for access.
	 *
