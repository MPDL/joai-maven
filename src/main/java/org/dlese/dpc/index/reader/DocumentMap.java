 ...
 * {@link org.apache.lucene.document.Document} as field/value pairs. All data is
 * loaded from the index into the Map when any Map accessor method is called
 * (e.g. eager loading), making data available even if the underlying index
 * later changes, but also making access to very large Documents inefficient.
 * Each stored field in the {@link org.apache.lucene.document.Document}
 ...
 * Document. Supports read operations only. A DocumentMap is available from
...
public class DocumentMap implements Map {
	 ...
	 * given field is not available or was not stored in the index. Text contains
	 * all stored values for the given field.
	 *
	 * @param fieldName
