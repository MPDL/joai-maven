 ...
 * {@link org.apache.lucene.document.Document} that was created by a
 * {@link org.dlese.dpc.index.writer.FileIndexingServiceWriter}. This class may
 * be extended for each {@link org.apache.lucene.document.Document} type that
 * might be returned in a search.
 *
...
public abstract class FileIndexingServiceDocReader extends DocReader implements Serializable {
	 ...
	 * {@link org.apache.lucene.document.Document} that was created by a
	 * {@link org.dlese.dpc.index.writer.DocWriter}.
	 *
	 * @param doc
	 ...
	 * {@link org.apache.lucene.document.Document}. This includes all XML or HTML
	 * tags, etc.
	 *
	...
	/**
	 * Gets the full content of the file that was used to index the
	 * {@link org.apache.lucene.document.Document}, returned in the given character
	 * encoding, for example UTF-8.
	 *
	 * @param characterEncoding
	 *            The character encoding to return, for example 'UTF-8'
	 * @return The full content as text, or empty string if unable to process.
	 */
	...
	/**
	 * Gets doctype associated with the {@link org.apache.lucene.document.Document},
	 * for example 'dlese_ims,' 'adn,' or 'html'. Note that to support wildcard
	 * searching, the doctype is indexed with a leading '0' appened to the
	 * beginning. This method strips the leading zero prior to returning.
	 *
	 ...
	 * {@link org.apache.lucene.document.Document} is deleted, indicated by a return
	...
	/**
	 * Determine whether the status of this
	 * {@link org.apache.lucene.document.Document} is deleted. This does not
	 * necessarily mean the file has been deleted.
	 * <p>
	 *
	 * Field: status [true]
	 *
	 ...
	 * {@link org.apache.lucene.document.Document} exists, indicated by a return
	 * value of "true".
	 *
	...
	/**
	 * Determine whether the file associated with this
	 * {@link org.apache.lucene.document.Document} exists.
	 *
	...
	/**
	 * Gets a String representataion of the File modification time of the File used
	 * to index the {@link org.apache.lucene.document.Document}. Note that while
	 * this represents the File modification time, this date stamp does not get
	 * updated until the File is re-indexed by the indexer.
	 *
	 ...
	 * {@link org.apache.lucene.document.Document}. Note that while this represents
	 * the File modification time, this date stamp does not get updated until the
	 * File is re-indexed by the indexer.
	 *
	 * @return The File modification time.
	 */
	...
	/**
	 * Gets the absolute path of the file that was used to index the
	 * {@link org.apache.lucene.document.Document}, encoded.
	 *
	 * @return The absolute path the the underlying file.
	 */
	...
	/**
	 * Gets the absolute path of the directory that contained the File used to index
	 * the {@link org.apache.lucene.document.Document}.
	 *
