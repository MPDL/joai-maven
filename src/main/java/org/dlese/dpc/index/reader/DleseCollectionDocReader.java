 ...
 * collection-level metadata record. The index writer that is responsible for
 * creating this type of Lucene {@link org.apache.lucene.document.Document} is a
 * {@link org.dlese.dpc.index.writer.DleseCollectionFileIndexingWriter}.
 *
...
public class DleseCollectionDocReader extends XMLDocReader {
	...
	/**
	 * Gets the String 'DleseCollectionDocReader,' which is the key that describes
	 * this reader type. This may be used in (Struts) beans to determine which type
	 * of reader is available for a given search result and thus what data is
	 ...
	 * collection was created, or null.
	 *
	 * @return The additional metadata as an String (may be an XML String), or null
	 *         if none.
	 */
	...
	/**
	 * Gets the title of the collection, for example 'DLESE Community Collection
	 * (DCC)', as indicated by the the vocab manager. If the vocab manger is not
	 * available, returns the same as {@link #getShortTitle}.
	 *
	 ...
	 * record refers to. For example, dcc or comet. This is NOT the key to the
	 * collection this record belogs to.
	 *
	...
	/**
	 * Gets the accession date of this collection, or null if this collection is
	 * currently not accessioned.
	 *
	 ...
	 *
	 * @return The URL to the collection's review process statement, or empty String
	 *         if not available.
	 */
	 ...
	 *
	 * @return The collection's review process statement, or empty String if not
	 *         available.
	 */
	...
	/**
	 * Gets the GradeRanges associated with this collection, encoded by the vocab
	...
	/**
	 * Gets the subjects associated with this collection, encoded by the vocab
	 * manager if it's available.
	 *
	...
	/**
	 * Gets the keywords as an array of Strings. Note that some keywords are
	 * actually phrases comprised of multiple words.
	 *
	 * @return The keywords
	 */
	...
	/**
	 * Gets the keywords a comma separated list terminated with a period suitable
	 * for display to users. For example: ocean, sea, rain.
	 *
	...
	/**
	 * Gets the contact contributor bean with that contains methods for accessing
	 * contributor information (Not implemented). Note: This is not yet implemented
	 * (returns null)!!!
	 *
	...
	/**
	 * Gets the responsibleParty contributor bean with that contains methods for
	 * accessing contributor information. Note: This is not yet implemented (returns
	 * null)!!!
	 *
	...
	private Contributor getContributor() {
		...
		return new PersonContributor(nameTitle, nameFirst, nameLast, instName, instDept, emailPrimary, emailAlt,
				contactID);
	}
	...
	/**
	 * A bean that holds information about a DLESE contributor that is an
	 * organization.
	 *
	 * @author John Weatherley
	 */
