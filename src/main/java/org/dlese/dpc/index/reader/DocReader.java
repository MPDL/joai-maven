 ...
 * 
 * that are returned from a search. All concrete DocReader classes must
 * implement a default no-argument
 * 
 * constructor so that they may be created automatically by the factory {@link
 * 
 * org.dlese.dpc.index.ResultDoc#getDocReader()}. In addition, the index writer
 * corresponding to the concrete
 * 
 * reader must implement the
 * {@link org.dlese.dpc.index.writer.DocWriter#getReaderClass()} method.
 *
 * 
 * 
...
public abstract class DocReader {
	...
	/**
	 * 
	 * Gets a String describing the reader type. This may be used in (Struts) beans
	 * to determine which type of
	 * 
	 * reader is available for a given search result and thus what data is available
	 * for display in the UI. The
	 * 
	...
	/**
	 * 
	 * An init method that may be used by concrete classes to initialize variables
	...
	/**
	 * 
	 * Called by {@link org.dlese.dpc.index.ResultDoc} at search time to initialize
	 * a new instance of a
	 * 
	 * DocReader.
	 *
	 ...
	 * 
	 * @param myScore
	 *            The Lucene score asigned to this hit
	 * 
	 * @param myConf
	 *            The config available to the doc reader
	 * 
	 */
	 ...
	 * {@link
	 * 
	 * org.apache.lucene.document.Document} that was created by a
	 * {@link org.dlese.dpc.index.writer.DocWriter}.
	 *
	 * 
	 * 
	 * @param myDoc
	 *            Gets the Lucene Document that is being read by this DocReader.
	 * 
	...
	/**
	 * 
	 * Gets the Lucene score for the {@link org.apache.lucene.document.Document}, or
	 * -1 if none available.
	 *
	 * 
	 * 
	 ...
	 * {@link org.dlese.dpc.index.SimpleLuceneIndex#setAttribute(String,Object)}.
	 *
	 * 
	 * 
	 * @param key
	...
	/**
	 * 
	 * Gets the RepositoryManager associated with this DocReader or null if not
	 * available. Assumes the
	 * 
	 * RepositoryManager has been set as attribute 'repositoryManager' in the
	 * SimpleLuceneIndex that was
	 * 
	 * searched.
	 *
	 * 
