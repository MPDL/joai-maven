 ...
 * {@link org.apache.lucene.document.Document} that was indexed by a
 * {@link org.dlese.dpc.index.writer.ErrorFileIndexingWriter}, which occurs when
 * there is an error while indexing a given file.
 *
...
public class ErrorDocReader extends FileIndexingServiceDocReader {
	...
	/**
	 * Gets the String 'ErrorDocReader,' which is the key that describes this reader
