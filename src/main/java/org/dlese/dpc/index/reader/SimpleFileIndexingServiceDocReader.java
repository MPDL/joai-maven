...
/**
 * 
 * A bean meant for subclassing that provides a basic implementataion of the
 * {@link
 * 
...
public class SimpleFileIndexingServiceDocReader extends FileIndexingServiceDocReader implements Serializable {
	 ...
	 * type. This may be used in
	 * 
	 * (Struts) beans to determine which type of reader is available for a given
	 * search result and thus what
	 * 
	 * data is available for display in the UI. The reader type determines which
