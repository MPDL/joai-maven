 ...
 * {@link org.apache.lucene.document.Document} that logs a single web request.
 * The index writer that is responsible for creating this type of Lucene
 * {@link org.apache.lucene.document.Document} is a
 * {@link org.dlese.dpc.index.writer.WebLogWriter}.
 *
...
public class WebLogReader extends DocReader {
	...
	/**
	 * Gets the fully qualified domain name the requesting IP. Best effort method,
	 * meaning we may not be able to return the FQDN depending on the underlying
	 * system configuration. If not avaialable, the the IP address is returned
	 * instead.
	 *
	 * @return The remote host domain name, for example mysite.org, or IP address if
	 *         not available
	 */
