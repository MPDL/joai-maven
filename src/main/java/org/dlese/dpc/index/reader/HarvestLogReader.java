 ...
 * {@link org.apache.lucene.document.Document} that logs a single OAI harvest.
 * The index writer that is responsible for creating this type of Lucene
 * {@link org.apache.lucene.document.Document} is a
 * {@link org.dlese.dpc.index.writer.HarvestLogWriter}.
 *
...
public class HarvestLogReader extends DocReader {
	...
	/**
	 * Gets the set if one was specified, or empty String. Note that the index
	 * stores 'noset' for the set if none was specified.
	 *
	...
	/**
	 * Gets the from datestamp of the form yyyy-MM-ddTHH:mm:ssZ used for this
	 * harvest, or null if none was used.
	 *
	...
	/**
	 * Gets the until datestamp of the form yyyy-MM-ddTHH:mm:ssZ used for this
	 * harvest, or null if none was used.
	 *
	...
	/**
	 * Gets the level of support for deleted records of the data provider, or null
	 * if not available.
	 *
	...
	/**
	 * Gets the date granularity supported by the data provider, or null if not
	 * available.
	 *
	...
	/**
	 * Gets the OAI error code that was returned by the data provider, for example
	 * 'noRecordsMatch', or null if not applicable. See <a href=
	...
	/*
	 * public String getError(){ String t = doc.get("error"); if (t == null) return
	 * ""; return t; } public String getOaiError(){ String t = doc.get("oaierror");
	 * if (t == null) return ""; return t; } public String getOaiErrorMsg(){ String
	 * t = doc.get("oaierrormsg"); if (t == null) return ""; return t; } public
	 * String getStatusMsg(){ String t = doc.get("status"); if (t == null) return
	 * ""; return t; }
	 */
	/**
	 ...
	 * {@link org.dlese.dpc.index.writer.DocWriter}. Sets the score to 0.
	 *
	 * @param doc
	 ...
	 * to determine which type of reader is available for a given search result and
	 * thus what data is available for display in the UI. The reader type implies
	 * which getter methods are available.
	 *
