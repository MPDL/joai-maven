...
/**
 * A QueryParser for extracting terms and phrases from a given query. Note: this
 * QueryParser does not return a usable Query.
 *
...
public class ExtractorQueryParser extends QueryParser {
	 ...
	 *
	 * @param defaultFieldInQuery
	 *            The defult field in the query you are parsing
	 * @param analyzer
	 *            The Analyzer to use when parsing the query
	 * @param fieldToExtract
	 *            The field you wish to extract the terms from
	 */
	 ...
	 * All terms are included, whether they were from a phrase or not.
	 *
