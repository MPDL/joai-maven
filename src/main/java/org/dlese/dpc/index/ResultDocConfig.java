...
/**
 * Contains the arbitraty attributes, the index and the users query, making them
 * available in DocReaders.
 *
...
public final class ResultDocConfig {
	 ...
	 *
	 * @param myQuery
	 *            The query that was used (as a String)
	 * @param luceneQueryObj
	 *            The Lucene Query object used
	 * @param myFilter
	 *            The Filter used to refine the search, or null if none used.
	 * @param docReaderAttributes
	 *            Attributes that will be made availalbe to DocReaders. May be null.
	 * @param myIndex
	 *            A pointer to the index that was searched over.
	 */
	public ResultDocConfig(String myQuery, Query luceneQueryObj, Filter myFilter, HashMap docReaderAttributes,
