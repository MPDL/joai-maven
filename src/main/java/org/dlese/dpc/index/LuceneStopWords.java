...
/**
 * This class simply loads a hashmap of Lucene stop words from the array given
 * by StopAnalyzer. This way a single map lookup can be used instead of
 * iterating over the array every time.
 *
...
public final class LuceneStopWords {
	...
	/**
	 * Keep a copy of the stop words here in case the Lucene package is not
	 * available
	 */
	public final static String[] ENGLISH_STOP_WORDS = {"a", "an", "and", "are", "as", "at", "be", "but", "by", "for",
			"if", "in", "into", "is", "it", "no", "not", "of", "on", "or", "s", "such", "t", "that", "the", "their",
