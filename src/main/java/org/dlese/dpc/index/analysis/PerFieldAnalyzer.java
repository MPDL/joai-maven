 ...
 * different analysis techniques. Use {@link #addAnalyzer} to add a non-default
 * Analyzer or {@link #addAnalyzersInBundle} to provide a ResourceBundle to
 * configure Analyzers on a field name basis. The ResourceBundle should contain
 * className=field1,field2,... pairs, where the field names are a
...
public class PerFieldAnalyzer extends Analyzer {
	...
	private org.apache.lucene.analysis.standard.StandardAnalyzer standardAnalyzer = new org.apache.lucene.analysis.standard.StandardAnalyzer(
			SimpleLuceneIndex.getLuceneVersion());
	...
	/**
	 * Constructs with the given Analyzer to use as a default for fields not
	 * otherwise configured. If null, a
	 * {@link org.apache.lucene.analysis.standard.StandardAnalyzer} will be used as
	 * the default.
	 *
	...
	/**
	 * Constructs using a
	 * {@link org.apache.lucene.analysis.standard.StandardAnalyzer} as the default
	 * for fields not otherwise configured.
	 */
	...
	/**
	 * Sets the Analyzer to use for the specified search field, overridding the
	...
	/**
	 * Adds the Analyzers to use for given fields, using the field=className pairs
	 * provided in the ResourceBundle, overrridding any previous ones if they
	 * existed. The ResourceBundle should contain className=field1,field2,... pairs,
	 * where the field names are a comma-separated list, for example:
	 * <p>
	 *
	 * <pre>
	 *org.dlese.dpc.index.analysis.SnowballAnalyzer=stems,titlestems
	 ...
	 * After removing, the given will will use the default Analyzer.
	 *
	 * @param fieldName
	 *            The field name
