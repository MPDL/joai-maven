 ...
 * is using at any given time. Useful for determining the memory requirements of
 * a given Object and for debugging possible memory leaks. See
 * <a href="http://www.javaworld.com/javaworld/javatips/jw-javatip130.html">
 * JavaWorld article</a> for more info. Includes a sample main method that shows
 * how it might be used.
 * <p>
 *
 * To get a snapshot of current memory first call <code>runGC()</code> and then
 * call <code>getUsedMemory()</code> .
 * <p>
 *
 * Example code:
 * <p>
...
public class MemoryCheck {
	...
	/**
	 * Gets the current amount of memory being used by this app, in bytes. For best
	 * accuracy you should call <code>runGC()</code> prior to calling this method.
	 *
	...
	/**
	 * Gets the current amount of memory being used by this app, in megabytes. For
	 * best accuracy you should call <code>runGC()</code> prior to calling this
	 * method.
	 *
	 * @return The current amount of memory being used by the JVM.
	 */
	...
	/**
	 * Runs object finization and the garbage collector several times. This tends to
	 * be more effective than juse calling garbage collection once.
	 */
