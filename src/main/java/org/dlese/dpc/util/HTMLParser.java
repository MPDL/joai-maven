...
/**
 * The HTMLParser class contains methods which allow an HTML document to be
 * parsed. These methods allow text in the document to be extracted, as well as
 * the contents of Meta tags Header (h1 , h2, h3, .. h6) tags, the Title tag,
 * all the links in the page etc.
 *
 * Example html document at http://www.abc.org: (for help with explaining the
 * methods in this API) <html> <head> <title> ABC.ORG's MAIN PAGE</title>
 * <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
 * <META NAME="keywords" CONTENT="DLESE, digital, library, earth, system,
 * education, science, ocean, atmosphere, resources, weather, volcano,
 * hurricane, earthquake, clouds, precipitation, acid, rain, snow, river, lake,
 * biology, data, dataset, curriculum, teacher, student, browse, find, grade
 * level, subject, standards, national, nsf">
 ...
 * <META NAME="doctype" CONTENT="ABC webpage"> </head> <body>
 * <h1>Welcome to ABC.ORG.</h1>
 * <h3>Hurricane season is here!</h3> <img src="abc.gif" alt="abc logo"> <br>
 * Whether directly affected or not, students can benefit from the engaging
 * learning experiences these dramatic events can provide. Keep abreast of the
 * current storm at the <a href="http://www.nhc.noaa.gov/"> Tropical Prediction
 * Center</a>, where you can view advisories, maps and forecast tracks.
 * <p>
 * Middle school students can learn about hurricane science and safety with the
 * <a href=" http://meted.ucar.edu/hurrican/strike/index.htm"> Hurricane
 * Strike</a> module, while more advanced students can utilize the <b>multimedia
 * technology of the online meteorology guide
 * <a href="http://ww2010.atmos.uiuc.edu/(Gh)/guides/mtr/hurr/home.rxml" title=
 * "hurricane page">Hurricanes</a></b>.
 * <p>
 * One of ABC's newest collections, the
 * <a href=" http://www.dlese.org/dds/query.do?q=hurricane&ky=00h&s=0" title=
 * "nasa page"> NASA Scientific Visualization Studio</a>, offers data, images
 * and animations from previous Atlantic storms.
 * 
 * </body> </html>
 *
...
public class HTMLParser {
	 ...
	 *                e.g.: HTMLParser hp = new HTMLParser("http://www.dlese.org");
	 ...
	 *
	 * @param htmlcontent
	 *            String containing the HTML to be parsed
	 * @param charset
	...
	/**
	 * returns all the text in the html page which is contained within header tags
	 * (which includes
	 * <h1>-
	 * <h6>). If none of these tags are present in the page, it returns an empty
	 * string. e.g. : HTMLParser hp = new HTMLParser("http://www.abc.org");
	 * System.out.println(hp.getHeaderText()); This prints out the following :
	...
	/**
	 * returns the title of the HTML page , i.e. the text enclosed by the <title>
	 * </title> tag. If this tag is not present in the page, it returns an empty
	 * string. e.g. : HTMLParserhp = new HTMLParser("http://www.abc.org");
	 * System.out.println(hp.getTitleText()); This prints out the following :
	 * 
	 * ABC.ORG's MAIN PAGE
	 *
	...
	/**
	 * returns true if the html document contains a Meta tag with a name equal to
	 * mname , otherwise returns false e.g. : HTMLParser hp = new
	 * HTMLParser("http://www.abc.org"); boolean containskeywords =
	 * hp.hasMetaTagName("keywords"); boolean containsxyz =
	 * hp.hasMetaTagName("xyz"); In this code, containskeywords will be true, and
	 * containsxyz will be false.
	 *
	 * @param name
	...
	/**
	 * returns the content of the Meta tag whose name equals mname. If such a tag
	 * does not exist, returns an empty string. E.g. : HTMLParser hp = new
	 * HTMLParser("http://www.abc.org"); if (hp.hasMetaTagName("organization")) {
	 * System.out.println(hp.getMetaTagContentByName("organization")); } This prints
	 * out the following :
	 * 
	 * ABC Program Center
	 *
	...
	/**
	 * returns a String containing all the text within the title attribute of all
	...
	/**
	 * returns a String containing all the text within the alt attribute of all the
	 * img tags in the html document
	 *
	 * @return all the text within the alt attribute of all the img tahs in the html
	 *         doc
	 * @exception ParserException
	 */
	 ...
	 * This text also includes the text within the alt attribute of all the img
	 * tags, as well as the text within the title attribute of all the link tags.
	 *
