...
public final class StringUtil {
	...
	/**
	 * Escape any single or double quotes within a string (usefull for strings that
	 * will be placed inside HTML inputs)
	 *
	 * @param str
	 */
	...
	public static String replace(String in, String find, String replace, boolean caseInsensitive) {
		...
		while (ind2 > -1) {
			ret.append(in.substring(ind1, ind2)).append(replace);
