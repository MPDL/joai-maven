...
public class MetadataUtils {
	...
	public final static Date parseUnionDateType(String dateString)
		...
		if (dateString.matches("[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]"))
			...
			return Utils.convertStringToDate(dateString + "-01-01MST", "yyyy-MM-ddz");
				...
				.matches("[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9][Tt][0-9][0-9]:[0-9][0-9]:[0-9][0-9][Zz]"))
			...
			throw new ParseException(
					"Unable to parse union date type: date must be one of yyyy-MM-dd, yyyy-MM, yyyy, yyyy-MM-ddtHH:mm:ssz but found "
							+ dateString,
					0);
	...
	/**
	 * 
	 * Converts an ISO8601 UTC datastamp of the form yyyy-MM-ddTHH:mm:ssZ or the
	 * short form yyyy-MM-dd to a Java
	 * 
	 * Date. See <a href="http://www.w3.org/TR/NOTE-datetime">ISO8601 </a> and <a
	 * 
	 * href="http://www.openarchives.org/OAI/2.0/openarchivesprotocol.htm#Dates">
	 * OAI date info</a> for more
	 * 
	 * info. If the short form yyyy-MM-dd is given, this method adds the String
	 * t01:00:00z to it to produce an
	 * 
	...
	/**
	 * 
	 * Converts a String of the union.dateType or ISO8601 UTC datastamp form to a
	 * Date. The possible forms
	 * 
