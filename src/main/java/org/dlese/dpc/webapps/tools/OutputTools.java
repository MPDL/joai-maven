...
public final class OutputTools {
	 ...
	 * valid prior to calling this method. This method produces exactly the same
	 * output as
	 * {@link org.dlese.dpc.xml.XMLConversionService#getContentFromXML(String)}.
	 *
	 * @param stg
	 *            An XML String.
	...
	/**
	 * Provides HTML encoding for XML resulting in text that looks good in a Web
	 * browser. Attempts to indent based on the XML structure rather than using the
	 * indentation in the text itself. Use this method to encode text that will be
	 * displayed in a web browser (e.g. JSP or HTML page).
	 * <p>
	 *
