...
/**
 * Performs gzipping of the response content. This is implemented using servlet
 * response Filter that takes the reqular ouput of a JSP or servlet and converts
 * it into a GZIP output stream. By encoding the output as GZIP, the size of
 * thresponse can be reduced by as much as 300%.
 *
...
public final class GzipFilter extends FilterCore {
	...
	public final void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		// prtln("Processing request: " + GeneralServletTools.getContextUrl(req) + "?" +
		// GeneralServletTools.getQueryString(req));
