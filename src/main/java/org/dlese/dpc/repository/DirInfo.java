 ...
 * Includes the directory name and the metadata format for the files in that
 * directory.
 *
...
public class DirInfo implements Serializable {
	 ...
	 *            The direcotory path
	 * @param format
	 *            The metadata format for the files in the directory
	 */
	...
	/**
	 * Provides a String representataion for this DirInfo. This method may be used
	 * for debugging to see what is in the DirInfo. This method is also used it the
