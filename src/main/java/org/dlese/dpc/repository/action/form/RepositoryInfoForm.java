...
/**
 * Bean for values used in the OAI Identify request including repository name,
 * description, admin e-mail, and namespace identifier.
 *
...
public final class RepositoryInfoForm extends ValidatorForm implements Serializable {
	 ...
	 *
	 * @param val
	 *            The new repositoryDescription value
	 */
	 ...
	 *
	 * @param val
	 *            The new namespaceIdentifier value
	 */
