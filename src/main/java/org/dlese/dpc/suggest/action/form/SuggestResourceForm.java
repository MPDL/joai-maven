 ...
 * {@link org.dlese.dpc.suggest.SuggestionRecord} the QA DataBase and Records.
 *
 * @author ostwald
...
public class SuggestResourceForm extends SuggestForm {
	 ...
	 * edit/display/re-edit cycle. preserveGradeRanges is set in
	 ...
	 *
	 * @param results
	 *            The new validatorResults value
	 */
	 ...
	 *
	 * @param val
	 *            The new preserveGradeRanges value
	 */
	...
	public LabelValueBean[] getGradeRangeOptions() {
		// List values = schemaHelper.getEnumerationValues("DLESEgradeRangeType",
		// false);
