...
/**
 * A Struts Form bean for handling submission of XML records based on XPath-name
 * HTML form inputs
 *
...
public class SuggestXMLForm extends ActionForm implements Serializable {
	 ...
	 *
	 * @param value
	 *            The new servicesSubmissionError value
	 */
