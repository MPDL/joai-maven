...
public abstract class SuggestAction extends Action {
	 ...
	 *                NOT YET DOCUMENTED
	 */
	protected abstract ActionForward initializeSuggestor(ActionMapping mapping, ActionForm form,
	 ...
	 * @return NOT YET DOCUMENTED
	 * @exception Exception
	 *                if SuggestionForm cannot be populated with required info.
	 */
	protected abstract ActionForward handleEditCommand(ActionMapping mapping, ActionForm form,
	 ...
	 * @return NOT YET DOCUMENTED
	 */
	protected abstract ActionForward handleCancelCommand(ActionMapping mapping, ActionForm form,
	 ...
	 * @return NOT YET DOCUMENTED
	 */
	protected abstract ActionForward handleDoneCommand(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response);
	 ...
	 * @return NOT YET DOCUMENTED
	 */
	protected abstract ActionForward handleSubmitCommand(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response);
	 ...
	 * @return Description of the Return Value
	 */
	protected ActionForward handleStaleData(ActionMapping mapping, ActionForm form, HttpServletRequest request) {
		SuggestForm sForm = (SuggestForm) form;
		sForm.clear();

		prtln("handleStaleData");
		ActionMessages actionMessages = new ActionMessages();
		actionMessages.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage("stale.data"));
		saveMessages(request, actionMessages);
		return mapping.findForward("home");
	}
	 ...
	 * @return Description of the Return Value
	 */
	protected abstract ActionErrors validateSuggestForm(ActionForm form, ActionMapping mapping,
