...
public class CommentRecord extends SuggestionRecord {
	...
	/**
	 * There may be more than one contributor element. We are assigning the role to
	 * the contributor/PERSON tagset.
	 *
	...
	/**
	 * Sets the role attribute of the CommentRecord object for the
	 * contributor/PERSON tagset.
	 *
	 * @param val
	 *            The new role value
	 * @exception Exception
	...
	/**
	 * Writes a String representaton of the date to various locations in the
	 * instance document.
	 * <p>
	 *
	 * @param dateStr
	 ...
	 * @exception Exception
	 *                if the creationDate cannot be set
	 */
	...
	public String toString() {
		try {
			...
			/*
			 * String email = getEmail(); if (email == null) { email = "unknown"; } s +=
			 * "\n\t email: " + email;
			 */
			return s;
		} catch (Exception e) {
