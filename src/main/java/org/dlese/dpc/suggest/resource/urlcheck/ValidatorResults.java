...
/**
 * Holds results of a search over a repository or a collection within a
 * repository for similar and/or duplicate records. Results are represented as
 * DupSim instances.
 *
 * @author ostwald
 *         <p>
...
public class ValidatorResults {
	...
	/**
	 * Adds a DupSim instance to the SimilarPrimaryUrl attribute of the
	 * ValidatorResults object
	 *
	 * @param sim
	 *            The feature to be added to the SimilarPrimaryUrl attribute
	 */
	...
	/**
	 * Adds a DupSim instance to the SimilarMirrorUrl attribute of the
	 * ValidatorResults object
	 *
	 * @param sim
	 *            The feature to be added to the SimilarMirrorUrl attribute
	 */
	 ...
	 *
	 * @param dupSims
	 *            The new similarMirrorUrls value
	 */
	 ...
	 *
	 * @param dupSims
	 *            The new similarPrimaryUrls value
	 */
	...
	public boolean hasSimilarUrls() {
		return (getSimilarPrimaryUrls().size() > 0 || getSimilarMirrorUrls().size() > 0);
	}
