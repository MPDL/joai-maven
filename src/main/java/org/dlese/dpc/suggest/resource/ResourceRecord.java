...
public class ResourceRecord extends SuggestionRecord {
	...
	/*
	 * private String contribXPath = null; private String urlXPath = null; private
	 * String titleXPath = null; private String descriptionXPath = null; private
	 * String gradeRangeXPath = null; private String nameFirstXPath = null; private
	 * String nameLastXPath = null; private String emailPrimaryXPath = null; private
	 * String instNameXPath = null; private String dateInfoXPath = null;
	 */
	 ...
	 * point (Suggest-a-url), none of the other fields have meaningful values, so we
	 * can simply wipe out the existing audiences and add new ones
	 *
	 * @param vals
	 ...
	 * contributor elements should have same date value (since they are set together
	 * - see <b>{@link ResourceRecord#setCreationDate}</b> we use
	 ...
	 * <p>
	 *
	 * issue: is it okay to use the same string representation for these nodes (they
	 * have different type definitions)
	 *
	 * @param dateStr
