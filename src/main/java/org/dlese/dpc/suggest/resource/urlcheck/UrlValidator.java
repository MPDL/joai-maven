 ...
 * collection within a repository) for ADN records having duplicate and/or
 * similar urls in it's primary or mirrorUrl fields.
 * <p>
 *
...
public class UrlValidator {
	 ...
	 *
	 * @param searchServiceBaseUrl
	 *            base url of the Search Service used to validate a url
	...
	/**
	 * Construct query string to be used by the Search Service to search for records
	 * containing matches to the provided url.
	 *
	 * @param url
	 ...
	 * MirrorUrls fields. If a collection is not specified, the entire repository is
	 * searched.
	 *
	 * @param url
	 *            referenceUrl
	...
	/**
	 * Create the query string to search for records containing similar urls to the
	 * provided url.
	 *
	 * @param url
	 *            Description of the Parameter
	...
	/**
	 * Return a ValidatorResults instance containing the results of a query to find
	 * duplicate and similiar urls in the primaryUrl and mirrorUrl fields of
	 * repository records.
	 *
	 * @param referenceUrl
