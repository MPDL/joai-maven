...
public final class SuggestCommentServlet extends HttpServlet {
	...
	public void init(ServletConfig conf) throws ServletException {
		...
		serviceHelper.setDcsStatus((String) context.getInitParameter("dcsStatus-comment"));

		serviceHelper.setDcsStatusNote((String) context.getInitParameter("dcsStatusNote-comment"));

		String emailFrom = (String) context.getInitParameter("emailFrom-comment");
		serviceHelper.setEmailFrom(emailFrom);

		String[] emailTo = SuggestUtils.commaDelimitedToArray((String) context.getInitParameter("emailTo-comment"));
		...
		/*
		 * SuggestCommentAction.setDebug(debug); SuggestCommentHelper.setDebug(debug);
		 * SuggestCommentForm.setDebug(debug); Emailer.setDebug(debug);
		 * CommentRecord.setDebug(debug); SuggestUtils.setDebug(debug);
