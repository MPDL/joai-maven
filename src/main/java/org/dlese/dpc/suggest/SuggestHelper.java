...
public abstract class SuggestHelper {
	 ...
	 *            template used to create new SuggestRecord instances
	 * @param schemaHelper
	 *            schemaHelper instance for this SuggestHelper's native framework
	 */
	...
	/**
	 * Gets the repositoryServiceClient attribute of the SuggestHelper object, used
	 * to place suggestions in a DCS instance.
	 *
	 ...
	 *
	 * @param wsc
	 *            The new repositoryServiceClient value
	 */
	...
	/**
	 * Creates a new {@link ResourceRecord} instance from the <i>recordTemplate </i>
	 * file.
	 *
