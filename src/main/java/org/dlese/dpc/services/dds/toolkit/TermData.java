...
public class TermData {
	 ...
	 * @param doccount
	 *            Number of documents (records) in the index in which the term
	 *            resides in the given field(s)
	 */
	...
	/**
	 * Number of documents (records) in the index in which the term resides in the
	 * given field(s).
	 *
