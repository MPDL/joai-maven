...
import org.dlese.dpc.services.dds.action.form.DDSRSS20Form;
...
public final class DDSRSS20Action extends Action {
	 ...
	 * response in RSS 2.0 format. This request exposes the same search options that
	 * users experience when performing a search for educational resources in the
	 * DDS, including what's new, etc..
	 * <p>
	 *
	 *
	 *
	 ...
	 *                If error.
	 */
	protected ActionForward doRssSearch(HttpServletRequest request, HttpServletResponse response, RepositoryManager rm,
			DDSRSS20Form rssForm, ActionMapping mapping) throws Exception {
		...
		// Perform the search...
		DDSStandardSearchResult standardSearchResult = DDSQueryAction.ddsStandardQuery(request, null, rm, vocab,
