 ...
 * Wraps the data returned from the ListTerms request to Java Maps and Objects.
 *
...
public class TermsInfo {
	 ...
	 *            Index version
	 * @param totalNumTerms
	 *            Total num terms in given fields
	 */
	...
	public String toString() {
		return "fields: " + Arrays.toString((String[]) fields.toArray(new String[]{})) + ", totalNumTerms: "
				+ totalNumTerms + ", termsMapSize: " + terms.size() + ", indexVersion: " + indexVersion;
	}
