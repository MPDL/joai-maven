...
public class DDSRepositoryFetcher {
	 ...
	 *
	 * @param baseUrl
	 *            DDS webservice baseUrl
	 * @param backupsDir
	 *            Destination repository to be written
	 * @param instanceName
	 *            name of repository used to name disk files
	 */
	 ...
	 * (e.g., "DLESE"), then the date ("2009_08-14"). If more than one fetch is done
	 * on a particular date, a version number is appended ("2009_08-14_1").
	 *
	 * @return The repositoryDir value
	 * @exception Exception
	 *                if repositoryDir cannot be initialized
	 */
	...
	/**
	 * Fetches the items in specified collection and writes them into collectionsDir
	 *
	 * @param collectionInfo
	 *            the collection to fetch
	 * @param collectionDir
	 *            destination for itemRecords on disk
	 * @exception Exception
	 *                if any error fetching or writing itemRecords to disk
	 */
