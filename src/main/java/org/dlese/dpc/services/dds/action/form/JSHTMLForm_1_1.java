...
public class JSHTMLForm_1_1 extends ActionForm implements Serializable {
	...
	/**
	 * Adds menu and item to the page. If the given menu does not exist it will be
	 * created and the item will be added, otherwise the item will be added to the
	 * given menu.
	 *
	 * @param menu
	...
	/**
	 * Gets a Map of the smart link menu labels, for example 'My custom menu', keyed
	 * by the menu number, for example 'slm0'.
	 *
	 ...
	 *
	 * @param menu
	 *            The menu name, for example 'My custom menu'
	...
	/**
	 * Gets a Map of the menu positions keyed by menu name, for example'My custom
	 * menu'.
	 *
	 * @return A map of positions, corresponding to slm0, slm1 etc, or null if no
	 *         menu has not been added yet
	 */
	...
	/**
	 * Gets a Map of all smart link menus keyed by menu name, for example 'My custom
	 * menu', with values containing Lists of the items in the given menu. This map
	 * should be used to create the menu in the UI.
	 *
	...
	/**
	 * Gets a Map of all items in the smart link menus, keyed by their menu and item
	 * number of the form slm0-0, where slm0 is the ID for the menu and 0 is the ID
	 * for the item in that menu.
	 *
	...
	/**
	 * Sets the Map of all items in the smart link menus, keyed by their menu and
	 * item number of the form slm0-0, where slm0 is the ID for the menu and 0 is
	 * the ID for the item in that menu.
	 *
	 * @param map
	 *            The new menu items map
	 */
	...
	/**
	 * Gets the names of the parameters used to refer to the all current smart
	 * links, for example slm0, slm1, etc.
	 *
	...
	public String getLocalizedRecordXml() {
		...
		if (recordFormat == null)
			...
			return xml.replaceAll("nsdl_dc:nsdl_dc", "ndsl_dc").replaceAll("<dc:", "<").replaceAll("<dct:", "<")
					.replaceAll("</dc:", "</").replaceAll("</dct:", "</");
		return xml;
	}
	...
	/**
	 * Gets the DocReader for the first item in the results. Appropriate for
	 * getRecord requests where you're accessing a record by ID.
	 *
