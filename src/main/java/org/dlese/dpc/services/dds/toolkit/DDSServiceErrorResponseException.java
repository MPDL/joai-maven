...
public final class DDSServiceErrorResponseException extends Exception {
	 ...
	 * @param msg
	 *            The error resonse message
	 * @param serviceRequest
	 *            The service request made
	 */
	...
	/**
	 * Gets the serviceResponseCode. A value of 'noRecordsMatch' indicates there
	 * were no matches for the given search.
	 *
	...
	/**
	 * Gets the serviceResponseMessage attribute of the
	 * DDSServiceErrorResponseException object
	 *
	...
	/**
	 * Gets the serviceRequestMade attribute of the DDSServiceErrorResponseException
	 * object
	 *
