...
/**
 * Represents one Record retrieved from the DDS, and its pertinent information.
 *
...
class Rec {
	 ...
	 *            accession status of the records
	 */
	Rec(String Id, String Collid, String Colllabel, String Xmlformat, String Accessionstatus) {
		this.id = Id;
		this.collid = Collid;
