...
public class MmdRec implements Comparable {
	...
	public final static String[] statusNames = {"unknown", "accessioneddiscoverable", "accessionednondiscoverable",
			"deaccessioned", "new", "rejected"};
	...
	public final static String[] metastyleNames = {"unknown", "adn", "briefmeta", "dc_qual", "dc_simple", "dlese_anno",
			"dlese_collect", "dlese_ims", "nsdl_dc", "news_opps", "oai_dc"};
	 ...
	 * @param metastyleStg
	 *            DESCRIPTION
	 * @param firstAccessionDate
	 *            DESCRIPTION
	 * @param lastMetaModDate
	 *            DESCRIPTION
	 * @param recCheckDate
	 *            DESCRIPTION
	...
	public MmdRec(String collKey, String id, String fileName, String statusStg, String metastyleStg,
			long firstAccessionDate, long lastMetaModDate, long recCheckDate, String primaryContent,
			String primarycontentType, MmdWarning[] warnings) throws MmdException {
		int ii;
		boolean foundit;
		...
		if (metastyle == MS_UNKNOWN)
			mkerror("MmdRec.const: invalid metastyle: \"" + metastyleStg + "\"");
	...
	/**
	 * Gets the primaryContent attribute of the MmdRec object and returns it after
	 * cleaning up the illegal character sequences "0x000d" and "0x0009"
	 * 
	...
	/**
	 * Returns the record status: for example, STATUS_ACCESSIONED_DISCOVERABLE. Must
	 * be one of the STATUS_ values above.
	 *
	...
	/**
	 * Returns the metadata format: for example, MS_ADN. Must be one of the MS_
	 * values above.
	 *
	...
	/**
	 * Returns an array of MmdWarning for messages generated during the most recent
	 * Idmapper run.
	 *
