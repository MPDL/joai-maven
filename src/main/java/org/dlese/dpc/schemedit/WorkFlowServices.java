...
public class WorkFlowServices implements StatusListener {
	...
	public void statusChanged(StatusEvent statusEvent) {
		...
		if (currentStatus != null && StatusFlags.isFinalStatusValue(currentStatus)) {

			/*
			 * This is where we USED to save assignments to casaaServer. Disabled when casaa
			 * was retired in favor of CAT REST service. There should be an equivalent call
			 * if we want to restore this feature.
			 */
	...
	/**
	 * Save assigned standards to CAT service.
	 * <p>
	 *
	 * NOTE: This is where we USED to save assignments to casaaServer. Disabled when
	 * casaa was retired in favor of CAT REST service. There should be an equivalent
	 * call if we want to restore this feature.
	 *
	 * @param docReader
	 *            NOT YET DOCUMENTED
	 */
	/*
	 * private void saveContentStandardAssignments(XMLDocReader docReader) { try {
	 * if (docReader == null) { throw new Exception("docReader is null"); } String
	 * xmlFormat = docReader.getNativeFormat(); MetaDataFramework framework =
	 * getMetaDataFramework(xmlFormat); if (framework == null) { throw new
	 * Exception("metadataFramework not found for \"" + xmlFormat + "\""); } if
	 * (framework.getStandardsManager() == null) {
	 * prtln("framework does not have nses4thLevelStandards - returning"); return; }
	 * 
	 ...
	 * 
	 * StandardsSuggestionService casaaService = (StandardsSuggestionService)
	 * servletContext.getAttribute("casaaService"); if (casaaService == null) {
	 * throw new Exception("\"casaaService\" not found in servletContext"); }
	 * 
	 * AsnToAdnMapper standardsMapper = (AsnToAdnMapper)
	 * servletContext.getAttribute("standardsMapper"); if (standardsMapper == null)
	 * { throw new Exception("\"standardsMapper\" not found in servletContext"); }
	 * 
	 * CasaaServiceHelper.saveAssignments(doc, framework, casaaService,
	 * standardsMapper); } catch (Exception e) {
	 * prtln("Unable to save content standards: " + e.getMessage()); } catch
	 * (Throwable t) { prtln("Unknown error trying to save content standards: " +
