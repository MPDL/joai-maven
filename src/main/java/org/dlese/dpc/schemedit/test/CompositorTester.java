 ...
 * <li>instanceDocPath - path to xml record on disk, and instance Document for
 * the Schema
 * <li>xpath - determines the instanceElement to be controlled by the Compositor
 * <ul>
 *
...
public class CompositorTester {
	...
	/**
	 * The compositor created by CompositorTester for the specified schema,
	 * instanceDocument, and xpath;
	 */
	...
	/**
	 * Gets the compositor for the specified xpath, using the tester's instance
	 * document
	 *
	 * @param xpath
	 *            Description of the Parameter
	...
	/**
	 * Obtains an instanceElement from the current instanceDocument at the specified
	 * path
	 *
	 * @param xpath
	 *            xpath used to select instanceElement
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * String schemaName = "mets"; String instanceDocPath =
		 * "C:/tmp/mets_record.xml"; String xpath =
		 * "/this:mets/this:fileSec/this:fileGrp/this:file/this:FContent/this:xmlData";
		 * 
		 * CompositorTester cgt = new CompositorTester(schemaName, xpath);
		 */

		/*
		 * CompositorGuard guard = cgt.getCompositorGuard(instanceDocPath); prtln
		 * ("\nPrinting Instance Members"); guard.printInstanceMembers();
		 */
	}
	...
	/**
	 * Tester for a Compositor's getMember method - retrieves a CompositorMember
	 * instance for the specified memberName
	 *
	 * 
	 */
	static CompositorMember findCompositorMember(String memberName, Compositor compositor) {
		...
		if (member != null) {
			prtln("\t... found member: " + member.getInstanceQualifiedName() + " - maxOccurs: " + member.maxOccurs
	...
	/**
	 * Create and insert a new element into the instanceDocument at a specified
	 * xpath.
	 *
	 * @param path
	 *            Description of the Parameter
