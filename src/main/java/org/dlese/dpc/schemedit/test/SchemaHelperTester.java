...
public class SchemaHelperTester {
	...
	/*
	 * encoded path, e.g.,
	 * "/annotationRecord/annotation/contributors/contributor_1_"
	 */
	...
	/*
	 * three cases 1 - simple Enumeration (GenericType.isEnumerationType()) ->
	 * genericType.getEnumerationValues 2 - comboUnion Type
	 * (SimpleType.isComboUnionType() -> genericType.getEnumerationValues (?will
	 * this work with comboUnions?) 3 - derivedTextOnlyModel (that extends either an
	 * enumeration or comboUnion) ComplexType.isDerivedTextOnlyModel -> work with
