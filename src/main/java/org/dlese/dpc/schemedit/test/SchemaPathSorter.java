...
public class SchemaPathSorter {
	...
	static String[] pathPoolFOO = {"_slash_news_dash_oppsRecord_slash_announcementURL",
			...
			"_slash_news_dash_oppsRecord_slash_contributors_slash_contributor_2__slash_organization_slash_instName",
			"_slash_news_dash_oppsRecord_slash_description", "_slash_news_dash_oppsRecord_slash_language_slash_@meta",
			"_slash_news_dash_oppsRecord_slash_language_slash_@resource", "_slash_news_dash_oppsRecord_slash_title"};
	...
	public class DocOrderComparator implements Comparator {
		...
		public int compare(Object o1, Object o2) {
			...
			cmp = schemaOrder.compare(SchemaHelper.toSchemaPath(path1), SchemaHelper.toSchemaPath(path2));
