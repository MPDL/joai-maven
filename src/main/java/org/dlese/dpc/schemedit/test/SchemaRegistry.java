...
public class SchemaRegistry {
	...
	Map getSchemaMap() {
		if (schemaMap == null) {
			...
			registerSchema("dlese_anno", "http://www.dlese.org/Metadata/annotation/1.0.00/annotation.xsd",
					"annotationRecord");

			registerSchema("oai_dc", "http://www.dlese.org/Metadata/oai_dc/2.0/oai_dc-DCvocab-nolang.xsd", "oai_dc:dc");

			registerSchema("dlese_collect", "/devel/ostwald/metadata-frameworks/collection-v1.0.00/collection.xsd", "");

			registerSchema("news_opps", "http://www.dlese.org/Metadata/news-opps/1.0.00/news-opps.xsd",
					"news-oppsRecord");

			registerSchema("adn", "http://www.dlese.org/Metadata/adn-item/0.6.50/record.xsd", "itemRecord");

			registerSchema("mets", "http://www.loc.gov/standards/mets/mets.xsd", "this:mets");

			registerSchema("attributeGroup",
					"http://www.dpc.ucar.edu/people/ostwald/Metadata/AttributeGroupTester/schema.xsd", "record");
			...
			registerSchema("play", "http://www.dpc.ucar.edu/people/ostwald/Metadata/NameSpacesPlay/cd.xsd", "cd:cd");

			registerSchema("ncs_collect", "http://ns.nsdl.org/ncs/ncs_collect/1.02/schemas/ncs-collect.xsd", "record");

			registerSchema("ncs_item", "http://ns.nsdl.org/ncs/ncs_item/1.02/schemas/ncs-item.xsd", "record");
			...
			registerSchema("dcs_data", "http://www.dpc.ucar.edu/people/ostwald/Metadata/dcs-data/dcs-data.xsd",
					"dcsDataRecord");

			registerSchema("mast", "http://www.dlsciences.org/frameworks/mast/1.0/schemas/mast-dc-gem.xsd", "record");

			registerSchema("concepts", "http://www.dlsciences.org/frameworks/concepts/1.0/schemas/concepts.xsd",
					"concept");

			registerSchema("my_concepts",
					"http://www.dls.ucar.edu/people/ostwald/Metadata/conceptsjlo/1.0/schemas/concepts.xsd", "concept");

			registerSchema("sif_activity", "http://www.dls.ucar.edu/people/ostwald/Metadata/sif/SIF_Message.xsd",
					"sif:Activity");

			registerSchema("sif_learning_resource",
					"http://www.dls.ucar.edu/people/ostwald/Metadata/sif/SIF_Message.xsd", "sif:LearningResource");

			registerSchema("fields_file", "http://www.dls.ucar.edu/people/ostwald/Metadata/fields/non-vocab-fields.xsd",
					"metadataFieldInfo");

			registerSchema("ead", "http://www.loc.gov/ead/ead.xsd", "ead");
			...
			registerSchema("smile_item", "http://howtosmile.org/Metadata/smile-item/0.1.0/smile-item.xsd", "smileItem");
			...
			registerSchema("ncs_user", "http://localhost/metadata-frameworks/ncs_user/ncsUserFramework.xsd", "record");

			registerSchema("res_qual", "http://ns.nsdl.org/ncs/res_qual/1.00/schemas/record.xsd", "record");

			registerSchema("osm", "http://nldr.library.ucar.edu/metadata/osm/1.0/schemas/osm.xsd", "record");

			registerSchema("osm_next", "http://nldr.library.ucar.edu/metadata/osm/1.1/schemas/osm.xsd", "record");

			registerSchema("eng_path", "http://ns.nsdl.org/ncs/eng_path/1.00/schemas/record.xsd", "record");
	...
	/**
	 * schema locations and notes. now we grab schemas from the schemaMap, so if we
	 * want to use one of these, add it to "getSchemaMap"
	 */
	static String getSchemaPath() {
		...
		/*
		 * this multi-namespace schema does not define a default namespace, and is
		 * processed properly
		 */
		String play = "http://www.dpc.ucar.edu/people/ostwald/Metadata/NameSpacesPlay/cd.xsd";
		/*
		 * this multi-namespace schema defines a default namespace, and is now processed
		 * properly
		 */
		String original = "/devel/ostwald/metadata-frameworks/NameSpaces/Original/cd.xsd";

		/*
		 * these nsdl_oai schemas define the XMLSchema namespace as the default, which
		 * requires conversion within DefinitionMiner ...
		 */
