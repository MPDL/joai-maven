...
public class DataStoreTester {
	...
	private void addExportingMessage(String msg) {
		ArrayList exportingMessages = (ArrayList) dataStore.get("EXPORTING_STATUS_MESSAGES");
	...
	public static void main(String[] args) {
		...
		/*
		 * dst.addExportingMessage ("Hello world. I am an indexing message"); prtln
		 * ("DataStoreTester created. Number of files: " +
		 * dst.dataStore.getNumRecords());
		 */
