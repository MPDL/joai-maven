...
/**
 * Class for testing metadata editor rendering on a specific node of a specific
 * framework
 *
 * @author ostwald
 */
public class RenderTester {
	...
	RenderTester(String xmlFormat, String stdSuggestConfigPath) throws Exception {
		...
		if (stdSuggestConfigPath != null) {
			try {
				SuggestionServiceManager ssMgr = new SuggestionServiceManager(new File(stdSuggestConfigPath));
				StandardsManager stdMgr = ssMgr.createStandardsManager(framework);
	...
	public static void main(String[] args) throws Exception {
		...
		org.dlese.dpc.schemedit.sif.SIFRefIdManager
				.setPath("C:/Documents and Settings/ostwald/devel/SIF/dcs_config/sifTypePaths");
