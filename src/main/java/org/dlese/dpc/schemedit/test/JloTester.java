 ...
 * {@link org.dlese.dpc.xml.schema.SchemaHelper} I am different
 * 
 * @author ostwald
 *         <p>
 *
...
public class JloTester {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * String path = "/editor/editorHTMLIncludes.jsp"; Element e =
		 * DocumentHelper.createElement ("foo"); e.setText ("<%@ include file=\"" + path
		 * + "\" %>"); pp (e);
		 * 
		 * String s = Dom4jUtils.prettyPrint(e);
		 * 
		 * String out = replaceDirectives(s); prtln ("out: " + out);
		 */
