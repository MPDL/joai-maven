 ...
 * @author ostwald
 *         <p>
 *         $Id: CollectionConfigTester.java,v 1.9 2009/03/20 23:33:57 jweather
 *         Exp $
 */
public class CollectionConfigTester {
	...
	public CollectionConfigTester(String configFileName) throws Exception {
		...
		// "/devel/ostwald/tomcat/tomcat/webapps/schemedit/WEB-INF/collection-config";
	...
	public static void main(String[] args) {
		...
		/*
		 * String id = "1113334213468"; tester.inspect (id);
		 */
	}
