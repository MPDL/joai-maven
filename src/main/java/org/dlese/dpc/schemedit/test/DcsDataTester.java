...
/**
 * Tester for {@link org.dlese.dpc.schemedit.dcs.DcsDataRecord} and related
 * classes.
 *
 * @author ostwald
 *         <p>
...
public class DcsDataTester {
	...
	public DcsDataTester(String format) {
		...
		// "/devel/ostwald/metadata-frameworks/dcs-framework/records";
		// String configDirPath =
		// "/devel/ostwald/tomcat/tomcat/webapps/schemedit/WEB-INF/framework-config";
	...
	void basicsTester() throws Exception {
		...
		/*
		 * dcsDataRecord.setStatus ("Holding"); dcsDataRecord.setLastEditor("olds");
		...
		/*
		 * dcsDataRecord.addStatusEntry(StatusFlags.IMPORTED_STATUS,
		 * "Imported via web service", "Unknown editor", changeDate);
		 */
