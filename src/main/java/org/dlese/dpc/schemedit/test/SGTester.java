...
public class SGTester {
	...
	void attachNewElement(String pathArg) throws Exception {
		prtln("\n---------------------");
	...
	/**
	 * select all substitutionGroup elements by building up complex xpath ORing
	 * together the xpaths for the individual members
	 */
	...
	/**
	 * given the path to a schemaNode that hasSubstitutionGroup(), return an array
	 * of LabelValueBean objects representing, the substitutionGroup, where both the
