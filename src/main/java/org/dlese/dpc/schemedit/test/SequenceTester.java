...
import org.dlese.dpc.xml.schema.compositor.SequenceGuard;
...
public class SequenceTester extends CompositorTester {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * grab the schemaNamespace. Here i'm grabbing it from the compositor, but this
		 * has not been tested ...
		 */
	...
	/**
	 * If the instanceElement can accept a new member, then the acceptable sequences
	 * should not be empty.
	 */
