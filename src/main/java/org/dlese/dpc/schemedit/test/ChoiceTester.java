...
import org.dlese.dpc.xml.schema.compositor.ChoiceGuard;
...
public class ChoiceTester extends CompositorTester {
	...
	void showOccurrences() {
		...
		/*
		 * showOccurrences (guard, "description"); showOccurrences (guard, "rating");
	...
	/**
	 * If the instanceElement can accept a new member, then the acceptable choices
	 * should not be empty.
	 */
