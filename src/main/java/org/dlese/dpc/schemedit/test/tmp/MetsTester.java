...
public class MetsTester {
	...
	public static void existingMetsDoc() {
		...
		try {
			Dom4jUtils.writePrettyDocToFile(tester.doc, new File("L:/ostwald/tmp/validate-sandbox/MetsTesterOut.xml"));
		} catch (Exception e) {
	 ...
	 * namespace prefix in the Mets document is "this", so your xpaths must also use
	 * this prefix.
	 */
