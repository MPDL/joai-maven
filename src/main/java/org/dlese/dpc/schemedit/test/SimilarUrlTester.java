...
public class SimilarUrlTester {
	...
	String[] poolUrls = {"http://www.google.com/one", "http://www.google.com/one/index.html",
			"http://www.google.com/first/index.html", "http://www.google.com/index.htm",
			"http://www.google.com/one/two/index.htm", "http://www.google.com/one/three/index.htm",
	 ...
	 * host, and port match those of the baseURL. NOTE: the urls we want to check in
	 * DCS will already pass this test because they are retrieved by a query string
	 ...
	 */
	void poolCompare() throws Exception {
