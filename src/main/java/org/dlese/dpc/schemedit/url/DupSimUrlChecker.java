...
public class DupSimUrlChecker {
	 ...
	 * @param referenceUrl
	 *            The url for which we look for duplicates and similar urls
	 * @param collection
	 *            The collection we look in
	 * @exception Exception
	 *                if required helper objects cannot be found in the servlet
	 *                context initialized.
	 */
	 ...
	 * that contain either a PrimaryURL or MirrorURL <b>similar</b> to the provided
	 * url.
	 *
	 * @return List of DupSim instances
	 */
	 ...
	 * <b>dupliate</b> of the provided url.
	 * <p>
	 *
	...
	private List getPrimaryDups() {
		...
		// search for results having the specified url. This record has not been indexed
		// yet,
	 ...
	 *
	 * @param results
	 *            An array of ResultDocs from which to extract the MirrorUrl values
	 * @return A list of DupSims containing all the MirrorUrls found in results.
	 */
	 ...
	 * @param xmlDocReader
	 *            NOT YET DOCUMENTED
	 * @return The primaryUrl, or an empty string if primaryUrl not found
	 */
