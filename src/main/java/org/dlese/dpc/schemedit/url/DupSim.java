...
/**
 * Class to hold results of searches for duplicate or similar URLs. Associates a
 * particular url with the record id and whether it represents a duplicate or
...
public class DupSim {
	 ...
	 * ResultDoc resultDoc = (ResultDoc) result; XMLDocReader docReader =
	 * (XMLDocReader) resultDoc.getDocReader(); DocumentMap docMap =
	 * resultDoc.getDocMap(); id = docReader.getId();
	 * 
	 * xmlFormat = docReader.getNativeFormat(); this.field = field; this.url =
	 * RepositoryService.getPrimaryUrl(resultDoc, framework); }
	 */
