...
/**
 * Includes math_path-specific kludges, most notably the
 * /record/general/subjects field, which requires an editing approach OTHER than
...
public class MathPathEditorRenderer extends Msp2EditorRenderer {
	...
	protected void renderSubjectsNode() {
		...
		Element subjectTag = df.createElement("math_path__subjects");
