...
/**
 * Displays an XML metadata record using the ViewerRenderer. DcsViewRecord
 * provides the view of the entire record for the DCS DcsViewRecord page
 *
 * @author ostwald
 *
 */
public class DcsViewRecord extends AutoForm {
	...
	/**
	 * The main program for the DcsViewRecord class. The first argument is command,
	 * the second is arg (if nec);
	 *
	 * @param args
