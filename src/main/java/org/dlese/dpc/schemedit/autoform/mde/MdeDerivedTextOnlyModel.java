 ...
 * complexType that uses a <b> simpleContent</b> element. SimpleContent elements
 * have base element that is "extended" by adding attributes.
 * <p>
 *
...
public class MdeDerivedTextOnlyModel extends MdeComplexType {
	 ...
	 * NOTE: we can't assume the base element is a SimpleType!<
	 */
	public void render() {
		...
		while (extnIterator.hasNext()) {
			...
			if (attElementName.equals("attribute")) {
				...
				prtln("WARNING: renderSimpleContent() expected attribute or attributeGroup but found: "
						+ attElementName);
				continue;
			}
	 ...
	 * <p>
	 *
	 * This method implemented so it can be overridden in
	 * {@link org.dlese.dpc.schemedit.autoform.DleseEditorRenderer} to suppress
