...
/**
 * Renders JSP for SimpleType schema elements in the metadata editor. SimpleType
 * elements have an input and no children elements or attributes.
 *
 * @author ostwald
 *         <p>
 *
...
public class MdeSimpleType extends MdeNode {
	...
	private boolean isMultiSelect() {
		return (typeDef != null && this.sh.isEnumerationType(typeDef) && this.sh.isMultiSelect(this.schemaNode));
	}
	...
	protected void render_edit_mode() {
		...
		if (sh.isRepeatingElement(normalizedXPath) && !sh.isRepeatingComplexSingleton(normalizedXPath)) {
