...
/**
 * Supports creation of jsp to view (as opposed to edit) an entire
 * MetaDataRecord within the metadata editor. Jsp is constructed by the
 * {@link EditorViewerRenderer}.
 *
 * @author ostwald
...
public class EditorViewRecord extends DcsViewRecord {
	...
	/**
	 * The main program for the EditorViewRecord class, to be invoked from the
	...
	/**
	 * Contruct a path for the single jsp page, in the case of single-page jsp, or
	 * the page that integrates the component jsp pages, in the case of
	 * batch-rendered frameworks.
	 *
	 * @param unused
	 *            NOT YET DOCUMENTED
	...
	protected String getMasterJspHeader() {
		...
		/*
		 * header +=
		 * "<%@ page import=\"org.dlese.dpc.schemedit.display.CollapseBean\" %>\n\n";
