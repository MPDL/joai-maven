...
/**
 * Class holding information about the paths for a SIF framework that can accept
 * References to other SIF objects, including the acceptable object types.
 *
...
public class SIFRefIdMap {
	...
	/**
	 * Gets comma-separated string containing SIF types accepted by element at given
	 * path.
	 *
	 * @param path
	 *            NOT YET DOCUMENTED
