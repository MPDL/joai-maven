...
public abstract class SIFDocReader extends NameSpaceXMLDocReader {
	...
	/*
	 * public static void main (String [] args) throws Exception { prtln ("howdy");
	 * String records =
	 * "C:/Documents and Settings/ostwald/devel/dcs-instance-data/ccs/records";
	 * String path = records +
	 * "/sif_curriculum/1210372130672/CUR-000-000-000-001.xml";
	 * 
	 * String xml = Files.readFile(path).toString();
	 * 
	 * SIFDocReader reader = new SIFDocReader (xml); prtln ("refId: " +
	 * reader.getRefId()); prtln ("title: " + reader.getTitle()); }
	 */
