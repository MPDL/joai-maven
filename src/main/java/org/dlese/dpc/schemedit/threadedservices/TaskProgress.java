...
/**
 * Class to report progress of a {@link MonitoredTask} via a json object.
 * <p>
 *
...
public class TaskProgress {
	 ...
	 *
	 * @param task
	 *            the task for which we report progress
	 */
	...
	public String getProgressReport() {
		...
		String reportXml = "<progress>" + "<status>" + status + "</status>" + "<msg>" + escapedMsg + "</msg>"
				+ "<total>" + getTotal() + "</total>" + "<done>" + getDone() + "</done>" + "<error>" + getError()
				+ "</error>" + "<percentComplete>" + Float.toString(percentComplete) + "</percentComplete>"
				+ "</progress>";
