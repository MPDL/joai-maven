...
public abstract class MonitoredTask {
	...
	/*
	 * public void initProgress (int total) { this.progress.init(total); }
	 * 
	 * public void updateProgress (int done) { this.progress.update(done); }
	 * 
	 * public float getPercentComplete () { return
	 * this.progress.getPercentComplete(); }
	 * 
	 * public void resetTaskProgress () { this.progress.reset(); }
	 */
