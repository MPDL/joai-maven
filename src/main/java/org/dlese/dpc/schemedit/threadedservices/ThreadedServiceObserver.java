 ...
 * threaded service process (E.g., Export or Validation) has completed and to
 * perform additional processing at that time.
 *
 * 
 */
public interface ThreadedServiceObserver {
	 ...
	 * additional processing that is required after indexing and will execute within
	 * the same indexing thread, thus blocking all other indexing operations until
