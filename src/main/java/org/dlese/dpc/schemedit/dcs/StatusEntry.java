 ...
 * {@link org.dlese.dpc.schemedit.dcs.DcsDataRecord}.
 * <p>
 *
...
public class StatusEntry {
	 ...
	 * @exception Exception
	 *                if the entryElement does not have an "status" element
	 */
	 ...
	 * @exception Exception
	 *                if the entryElement does not have an "statusNote" element
	 */
	 ...
	 * @exception Exception
	 *                if the entryElement does not have an "editor" element
	 */
	 ...
	 * not been set, then set it as "now" and return the corresponding date object.
	 *
	 * @return The date value
	 */
	public Date getDate() {
		String changeDate = "";
		// make sure the changeDate is of the right form by first checking that it can
		// be parsed
		// by parseUnionDateType, and then convert the changeDate to a fullDateFormatted
		// date object
		try {
