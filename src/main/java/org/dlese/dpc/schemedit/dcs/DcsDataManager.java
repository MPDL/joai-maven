 ...
 * {@link org.dlese.dpc.schemedit.dcs.DcsDataRecord} instances that house
 * workflow status associated with each metadata record managed by the DCS.
 * <p>
 *
...
public class DcsDataManager {
	 ...
	 * @param dcsDataFramework
	 *            MetaDataFramework for the dcs_data format
	 * @param collectionRegistry
	 *            NOT YET DOCUMENTED
	 */
	public DcsDataManager(RepositoryManager rm, MetaDataFramework dcsDataFramework,
	...
	public static File getDcsDataDir(RepositoryManager rm) {
		...
		/*
		 * File dcsDataDir = new File(metadataRecordsLocation, "dcs_data"); if
		 * (!dcsDataDir.exists()) { dcsDataDir.mkdir(); prtln("dcsDataDir created"); }
		 * return dcsDataDir;
		 */
	}
	...
	/**
	 * Gets a dcsDataRecord without specifying an id. Necessary to support indexing,
	 * {@link org.dlese.dpc.schemedit.dcs.DcsDataFileIndexingPlugin} where the ID is
	 * not known or easily obtainable.
	 *
	 * @param collection
	 *            Description of the Parameter
	 * @param xmlFormat
	...
	/**
	 * Returns an empty dcsDataRecord corresponding to an indexed source record. The
	 * DcsDataRecord is a place holder for dcs-data, and is asociated with a file
	 * that will hold the dcs-data record for the source record.
	 *
	 * @param collection
	 *            The collection of the source record
	 * @param xmlFormat
	 *            Description of the Parameter
	 * @param fileName
