...
public final class CollectionAccessForm extends ActionForm {
	...
	/**
	 * Sets the sets attribute of the RepositoryAdminForm object. The set items are
	 * instances of {@link org.dlese.dpc.schemedit.dcs.DcsSetInfo}.
	 *
	 * @param setInfoSets
	 *            The new sets value
	 */
	...
	/**
	 * Create a representation of the user's roleMap, only using collection NAMES
	 * for the key, and a RoleBean (collection, role) for the map's values.
	 */
	public Map getUserRoles(String username) {
		...
		try {
			for (Iterator i = collections.iterator(); i.hasNext();) {
				...
				roles.put(colName, new RoleBean(colKey, role));
			}
		} catch (Throwable t) {
