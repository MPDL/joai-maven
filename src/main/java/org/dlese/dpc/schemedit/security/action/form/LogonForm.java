...
public final class LogonForm extends ActionForm {
	 ...
	 * an <code>ActionErrors</code> object that encapsulates any validation errors
	 * that have been found. If no errors are found, return <code>null</code> or an
	 * <code>ActionErrors</code> object with no recorded error messages.
	 *
	 * @param mapping
	 *            The mapping used to select this instance
	 * @param request
