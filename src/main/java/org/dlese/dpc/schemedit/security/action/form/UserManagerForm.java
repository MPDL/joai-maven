 ...
 * {@link org.dlese.dpc.schemedit.security.action.UserManagerAction}.
 *
...
public final class UserManagerForm extends ActionForm {
	 ...
	 *
	 * @param options
	 *            The new collectionOptions value
	 */
	 ...
	 * 
	 * public void setCollections (List options) { prtln ("setting " +
	 * options.size() + " collections"); collections = options; }
	 */
	private String role;
	...
	public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
		...
		if (command != null && (command.equals("edit") || command.equals("save"))) {
			UserManager userManager = (UserManager) getServlet().getServletContext().getAttribute("userManager");
			if (username == null) {
				...
				if (user == null) {
					...
					errors.add(ActionErrors.GLOBAL_ERROR, new ActionError("error.username.notfound", username));
				}
			}
		}
