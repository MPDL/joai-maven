...
public class GuardedPath {
	...
	/*
	 * public String getUrlMapping () { if (urlMapping == null) urlMapping =
	 * UrlPattern.getUrlMapping (path); return urlMapping; }
	 */
	...
	public void setActions(List actions) {
		...
		/*
		 * if (getIsActionMapping()) prtln ("\t IS ActionMapping: "); else prtln
		 * ("\t is NOT  ActionMapping: ");
		 */
	}

	/*
	 * public void setPath (String path) { this.matcher = new UrlPatternMatcher; }
	 */
