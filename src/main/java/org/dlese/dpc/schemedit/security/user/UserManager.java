...
/**
 * Manages {@link User} instances and provides information about users inlcuding
 * roles, attributes, preferences, etc.
 * <p>
 *
...
public class UserManager {
	 ...
	 *
	 * @param userDataDir
	 *            directory containing XML files of user data
	 * @exception Exception
	 ...
	 * @exception Exception
	 *                if user for provided username exists.
	 */
	...
	public void deleteUser(String username) {
		...
		File deletedUser = new File(user.getSource().getParentFile(), username + ".deleted");
	 ...
	 *            user to be saved
	 * @exception Exception
	 *                if provided user does not have a username
	 */
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * for (Iterator i=um.readUsers().iterator();i.hasNext();) { / prtln (
		 * ((User)i.next()).toString()); User user = (User)i.next(); prtln ("\n" +
		 * user.getUsername()); for (Iterator ii=Roles.roles.iterator();ii.hasNext(); )
		 * { Roles.Role r = (Roles.Role)ii.next(); prtln ("\t has role " + r + ": " +
		 * user.hasRole (r)); } }
		 */
	}
