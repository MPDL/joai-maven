...
public final class AccessManagerAction extends DCSAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if ("create".equals(command)) {
			...
			if (path == null) {
				errors.add(ActionErrors.GLOBAL_ERROR, new ActionError("generic.error", "no path supplied"));
				saveErrors(request, errors);
				return (mapping.findForward("edit.access"));
			}
			...
			/*
			 * new path: - create a new path (checking to make sure it is a legal pattern
			 * and it does not already exist) - add new path to accessManager
			 */
			if (amForm.isNewPath()) {
