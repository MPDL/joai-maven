...
public class User {
	 ...
	 *            User data file
	 * @exception Exception
	 *                if the user cannot be instantiated
	 */
	...
	public User() throws Exception {
		String userRecordTemplate = Files
				.readFileFromJarClasspath("/org/dlese/dpc/schemedit/security/user/USER-RECORD-TEMPLATE.xml").toString();
	...
	/**
	 * Gets the effective role for this collection, meaning if there is no explicit
	 * role assigned, use the default.
	 *
	 * @param collection
	 *            the collection
	...
	/**
	 * Returns true if this User has a role statisfying provided Role in the
	 * specified collection.
	 *
	 * @param roleStr
	 *            specified role (as string)
	 * @param collection
	 *            the collection
	 ...
	 * @param role
	 *            specified role
	 * @return true if this User has a role statisfying provided Role in any
	 *         collection
	 */
	...
	/**
	 * Returns true if this User has at least the specified role in the specified
	 * collection
	 *
	 * @param role
	 *            the role
	...
	/**
	 * Does this user have a role higher than the provided for the specified
	 * collection
	 *
	 * @param role
	 *            NOT YET DOCUMENTED
	...
	/**
	 * Write this User to disk and reset data structures so they will be reloaded
	 * from disk.
	 *
	 * @exception Exception
	 *                Description of the Exception
	...
	public static void main(String[] args) throws Exception {
		...
		// String filepath =
		// "/Users/ostwald/devel/dcs-records/2009_06_10-records/ncs_user/1246745355106/NCS_USER-000-000-000-006.xml";
		...
		prtln(user.toString());
		/*
		 * pp (user.prefMapToElement()); pp (user.rolesMapToElement());
		 */
	}
