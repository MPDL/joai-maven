...
public final class AccessUtils {
	...
	/**
	 * build a list of users who are managed by the current sessionUser. This list
	 * contains all the users who have permission to access any of the collections
	 * managed by the sessionUser. Admin users manage all other users, including
	 * other admins.
	 */
	public static List getManagedUsers(User sessionUser, List authorizedSets, UserManager userManager,
