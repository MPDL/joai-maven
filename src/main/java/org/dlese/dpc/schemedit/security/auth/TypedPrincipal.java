...
/**
 * This class is based on the Tagish JAAS Login Modules
 * (http://thekirschners.com/tagish-jaas/), and extended only to add
 * "COLLECTION" and "AUTH" principles.
 *
...
public class TypedPrincipal implements Principal, Serializable {
	...
	/**
	 * Compares the specified Object with this <code>TypedPrincipal</code> for
	 * equality. Returns true if the given object is also a
	 * <code>TypedPrincipal</code> and the two TypedPrincipals have the same name
	 * and type. If the object is any other kind Principal its will be considered
	 * equal if the name matches.
	 *
	 * <p>
	 *
	 * @param o
	 *            Object to be compared for equality with this
	 *            <code>TypedPrincipal</code>.
