 ...
 *
 * Based on
 * <A HREF="http://dione.zcu.cz/~toman40/JAASModule/doc/tagish/index.html">
...
public abstract class SimpleLogin extends BasicLogin {
	...
	/**
	 * Place the specified <CODE>Principle</CODE> in the subject and also record it
	 * in our principles <CODE>Vector</CODE> so we can remove them all later.
	 *
	 * @param s
