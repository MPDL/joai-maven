...
public class PasswordHelper {
	...
	public static PasswordHelper getInstance() {
		if (instance == null) {
			// prtlnErr ("ERROR: passwordHelper must first be initialized with a password
			// file");
	...
	/*
	 * private class User { char password[]; Vector principals; }
	 */
	/**
	 ...
	 * @exception Exception
	 *                if User not found for supplied username
	 */
