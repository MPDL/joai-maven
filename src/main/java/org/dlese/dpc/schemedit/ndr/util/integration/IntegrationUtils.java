...
public class IntegrationUtils {
	...
	static void setServiceDescriptions() throws Exception {
		...
		/*
		 * MetadataReader mdReader = collection.nsdlColl.metadata; ModifyMetadataRequest
		 * request = new ModifyMetadataRequest (mdReader.getHandle());
		 * 
		 * Element nsdl_dc = mdReader.getDataStream("nsdl_dc"); pp (nsdl_dc);
		 * request.setDataStream("nsdl_dc", nsdl_dc);
		 * request.setDataInfoStream("nsdl_dc", myInfoStream.asElement());
		 * request.submit();
		 */
