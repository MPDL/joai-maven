...
public class SyncReport {
	...
	/*
	 * public void addEntry (String id, String command, String resourceHandle,
	 * InfoXML response) { entryMap.put (id, new SyncReportEntry (id, command,
	 * resourceHandle, response)); }
	 * 
	 * public void addEntry (String id, String errorMsg) { entryMap.put (id, new
	 * SyncReportEntry (id, errorMsg)); }
	 */
