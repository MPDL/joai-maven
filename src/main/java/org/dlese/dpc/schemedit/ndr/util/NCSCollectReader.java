...
public class NCSCollectReader {
	...
	public static void main(String[] args) throws Exception {
		...
		if (readFromFile) {
			...
			File dir = new File(
					"C:/Documents and Settings/ostwald/devel/dcs-instance-data/local-ndr/records/ncs_collect/1256687231238");
	...
	public void serviceDescriptionTest() {
		ServiceDescription sd = ServiceDescription.makeServiceDescription(this, NDRConstants.NDRObjectType.AGGREGATOR);
		pp(sd.asElement());
	}
	...
	/**
	 * Gets the text of the node at the specified xpath, or null if no node exists.
	 *
	 * @param xpath
	 *            NOT YET DOCUMENTED
