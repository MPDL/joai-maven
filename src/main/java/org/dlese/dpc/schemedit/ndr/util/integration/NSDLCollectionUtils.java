...
public class NSDLCollectionUtils {
	...
	/**
	 * Creates and tests a {@link org.dlese.dpc.ndr.reader.NSDLCollectionReader}
	 * instance.
	 *
	 * @exception Exception
	...
	public static void compare(NSDLCollectionReader nsdl, NCSCollectReader ncs) {
		...
		/*
		 * prtln ("harvestInfo sets: "); for (Iterator
		 * i=nsdl.getHarvestInfo().getSets().iterator();i.hasNext();) prtln ("\t" +
		 * (String)i.next());
		 */
		prtln("NCS Collect");
