...
/**
 * Reads an XML file containing mappings between ncsrecordid and aggregator
 * handle, and produces an XML file containing more detailed information about
 * the NCS Collection record and the NDR Collection Objects associated with the
 * aggregator.
 * 
...
public class MappingsData {
	...
	static final String COLLECTION_ADMIN_AGENT = "2200/NSDL_COLLECTION_ADMIN";
	...
	public static void main(String[] args) throws Exception {
		...
		// Element mapping = makeMapping ("NSDL-COLLECTION-2669651",
		// "2200/20061129120245867T");
		// pp (mapping);
	...
	static void populateNDRInfo(Element element, String aggHandle) throws Exception {
		...
		/*
		 * try { itemcount = Integer.toString(reader.mdp.getMemberCount()); } catch
		 * (Throwable t) {}
		 */
