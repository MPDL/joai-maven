...
/**
 * Class to construct serviceDescription elements to be used in NDR Objects
 * (i.e., MetadataProvider and Aggregator), as described at
 * http://ndr.comm.nsdl.org/cgi-bin/wiki.pl?addMetadataProvider.
 *
...
public class ServiceDescription {
	...
	/**
	 * Constructor for the ServiceDescription object, given title, description and
	 * type values.
	 *
	 * @param title
	 *            NOT YET DOCUMENTED
	...
	private Element getRootElement() {
		 ...
		 * root.add(DocumentHelper.createNamespace("ieee",
		 * "http://purl.org/ieee/phony_namespace"));
		 */
	...
	public static void main(String[] args) throws Exception {
		...
		NCSCollectReader reader = org.dlese.dpc.schemedit.ndr.util.integration.NSDLCollectionUtils.getNCSRecord(recId);

		ServiceDescription sd = ServiceDescription.makeServiceDescription(reader,
	...
	/**
	 * Creates a service description instance based on information provided as
	 * NCSCollectReader.
	 *
	 * @param ncsDocReader
	 *            reader for a ncs_collect record.
	...
	public static ServiceDescription makeServiceDescription(NCSCollectReader ncsDocReader,
		...
		if (ncsDocReader.getBrandURL() != null && ncsDocReader.getBrandURL().trim().length() > 0) {
			sd.setImage(ncsDocReader.getBrandURL(), ncsDocReader.getTitle(), ncsDocReader.getImageWidth(),
					ncsDocReader.getImageHeight(), ncsDocReader.getAltText());
		}
	 ...
	 *
	 * @param reader
	 *            reader representing a dlese_collect record
	 * @return serviceDescription instance
	 */
