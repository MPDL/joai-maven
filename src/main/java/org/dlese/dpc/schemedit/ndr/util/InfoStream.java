...
/**
 * See http://ndr.comm.nsdl.org/cgi-bin/wiki.pl?addMetadata for documentation of
 * the InfoStream in MetadataObjects.
 * <p>
 *
 * NOTE: OAI Harvest info is not relevant to NCS collections, but is required in
 * the info stream, so we use values that will at lease schema-validate for
...
public class InfoStream {
	 ...
	 * Constructor for the InfoStream object
	 *
	 * @param nsdlAboutCategory
	 *            either "item" or "collection"
	 * @param repositoryPrimaryIdentifier
	 *            metadata identifier (resourceUrl)
	 * @param link
	 *            itemId property from collection metadata object
	 * @param metadataNamespace
	 *            XML namespace URI of this format's metadata.
	 * @param harvestIdentifier
	 *            the metadata provider's unique ID for this metadata. (e.g. the
	 *            metadata provider's OAI identifier). This should be the same as
	 *            the value of the uniqueID property.
	 */
	public InfoStream(String harvestIdentifier, String nsdlAboutCategory, String repositoryPrimaryIdentifier,
			String link, String metadataNamespace) {
	 ...
	 *
	 * @param nsdlAboutCategory
	 *            The new nsdlAboutCategory value
	 */
	 ...
	 *
	 * @param repositoryPrimaryIdentifier
	 *            The new repositoryPrimaryIdentifier value
	 */
	 ...
	 *
	 * @param harvestHarvestType
	 *            The new harvestHarvestType value
	 */
	 ...
	 *
	 * @param harvestDatasourcePublic
	 *            The new harvestDatasourcePublic value
	 */
	 ...
	 *
	 * @param harvestDatasource
	 *            The new harvestDatasource value
	 */
	 ...
	 *
	 * @param harvestIdentifier
	 *            The new harvestIdentifier value
	 */
	 ...
	 *
	 * @param harvestRecordDatestamp
	 *            The new harvestRecordDatestamp value
	 */
	...
	private Element getRootElement() {
		...
		// root.add(DocumentHelper.createNamespace("dc",
