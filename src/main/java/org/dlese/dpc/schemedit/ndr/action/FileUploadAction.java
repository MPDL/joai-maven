...
public class FileUploadAction extends Action {
	 ...
	 *                NOT YET DOCUMENTED
	 */
	ActionForward doUpload(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		prtln("doUpload");
		ActionErrors errors = new ActionErrors();
		FileUploadForm uploadForm = (FileUploadForm) form;
	...
	/**
	 * A stub used to develop user-interaction without requiring actuall uploading.
	 *
	 * @param mapping
	 *            the ActionMapping
	 * @param form
	 ...
	 *                NOT YET DOCUMENTED
	 */
	ActionForward doUploadFake(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		prtln("doUploadFake");
		ActionErrors errors = new ActionErrors();
		try {
