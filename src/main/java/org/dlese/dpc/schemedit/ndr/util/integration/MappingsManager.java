...
public class MappingsManager {
	...
	// "H:/Documents/NDR/CollectionsIntegration/2008_03_11/CurrentMappingData.xml";
	...
	/*
	 * public static MappingsManager getInstance () { if (instance == null) { try {
	 * instance = new MappingsManager(); } catch (Exception e) { prtln
	 * ("MappingsManager init error: " + e.getMessage()); } } return instance; }
	 */
	...
	public static void main(String[] args) throws Exception {
		CIGlobals.setup();
		// MappingsManager.dataPath =
		// "H:/Documents/NDR/CollectionsIntegration/CollectionMappingData/server7MappingData.xml";
	...
	void init() throws Exception {
		...
		for (Iterator i = nodes.iterator(); i.hasNext();) {
			...
			try {
				...
				this.add(info);
				/*
				 * mappings.add (info); idMap.put (info.getId(), info); aggMap.put
				 * (info.getAggregatorHandle(), info);
				 */
			} catch (Exception e) {
