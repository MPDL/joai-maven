...
/**
 * Utilities to find the metdata objects in the NDR that have an "old-style"
 * prefix ("oai:dls.org") for the nsdl:itemId property, and convert to the
 * "new-style" prefix ("oai:nsdl.org:ncs").
 *
 * @author ostwald
 */
public class ItemIdFixer {
	...
	public static void main(String[] args) throws Exception {
		...
		String[] stillToProcess = {"2200/20080125175222797T", "2200/20080125175222268T", "2200/20080220110441105T",
				"2200/20080228151642493T", "2200/20080125102313822T"};
		...
		try {
			...
			/*
			 * String mdHandle = "2200/20080124181837730T"; fixer.processMetadata
			 * (mdHandle);
			 */
