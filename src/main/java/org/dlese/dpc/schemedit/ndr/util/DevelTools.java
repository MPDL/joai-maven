...
public class DevelTools {
	...
	public static void modifyMetadataProvider() throws Exception {
		...
		// request.addCommand ("relationship", "aggregatedBy",
		// "2200/test.20070726184936697T", "delete");
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * NdrObjectReader.setDebug(false); setDebug(true);
		 * 
		 * String aggHandle = "2200/test.20070726190044390T"; prtln
		 * ("collectionMetadata: " + findCollectionMetadata (aggHandle));
		 */
