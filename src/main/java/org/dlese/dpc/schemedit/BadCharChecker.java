...
/**
 * Checks XML documents for presence of bad characters and builds a list of
 * BadCharEntries containing the element xpath and value containing the bad
 * char.
 *
 * @author ostwald
 *         <p>
...
public class BadCharChecker {
	...
	/**
	 * First checks for the presense of a "badChar" in the document as a string, and
	 * if one is found creates a list of BadCharEntry
	 */
