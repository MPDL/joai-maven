 ...
 * reindexing the entire repository (all collections). This is necessary because
 * if metadata records have been added by hand (outside the DCS), then the
 * existing "nextID" may no longer be valid.
 *
 * @author ostwald
 *         <p>
 *
...
public class CollectionIndexingObserver implements FileIndexingObserver {
	 ...
	 *            the collectionRegistry (contains IDGenerators)
	 * @param rm
	 *            the repositoryManager
	 */
	public CollectionIndexingObserver(String collectionKey, CollectionRegistry collectionRegistry,
			RepositoryManager rm) {
	 ...
	 *
	 * @param status
	 *            status code returned by indexer
	 * @param message
	 *            indexing message
	 */
