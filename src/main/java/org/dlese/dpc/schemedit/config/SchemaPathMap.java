...
/**
 * Map holding {@link org.dlese.dpc.schemedit.config.SchemaPath} instances that
 * are defined in the framework configuration files, instantiated by
 * FrameworkConfigReader instances, and accessed by MetaDataFramework.
 *
 * @author ostwald
 *         <p>
 *
...
public class SchemaPathMap {
	...
	/**
	 * CopyRecordPaths represent schema fields that will be copied to new records
	 * during record copy operations.
	 *
	 * @return SchemaPaths having value of "true" for the "requiredByCopyRecord"
	 *         attribute
	 */
	...
	/**
	 * CollectionConfigPaths represent schema fields that hold default information
	 * that will be inserted in new records.
	 * <p>
	 *
	 * For example, the ADN framework config contains collectionConfig paths for
	 * "termsOfUse", among others.
	 *
	 * @return SchemaPaths having value "collectionConfig" for the valueType
	 *         attribute
	 */
	 ...
	 *
	 * @return SchemaPaths having value of "true" for the "requiredByMinimalRecord"
	 *         attribute
	 */
	...
	/**
	 * Return a list of xpaths for which an initialFieldCollapse state has been
	 * specified"
	 */
	...
	/**
	 * Returns list of SchemaPath instances whose valueType is contained in the
	 * given list of pathTypes.
	 *
	 * @param valueTypes
	 *            NOT YET DOCUMENTED
	...
	/**
	 * Returns lists of xpaths instances representing fields configured as
	 * "readOnly".
	 * <p>
	 *
	 ...
	 *
	 * @param schemaPath
	 *            SchemaPath instance to be added.
	 */
