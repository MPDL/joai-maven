 ...
 * <p>
 *
 * For all but "Final status flags", the value and label are the same. For Final
 * flags, the value is an encoded string that allows the system to identify the
 * flag as a Final (see StatusFlags).
 *
 * @author ostwald
 *         <p>
 *
...
public class StatusFlag implements Serializable {
	 ...
	 * {@link org.dom4j.Element} and parses it into label and description values.
	 *
	 * @param statusFlagElement
	 *            Description of the Parameter
	 * @exception Exception
	 *                if unable to parse into label and description values
	 */
	public StatusFlag(Element statusFlagElement) throws Exception {
