 ...
 * required by the Indexer, and which should be displayed as read-only fields in
 * the metadata editor.
 * <p>
 *
 * SchemaPath instances are created by the
 * {@link org.dlese.dpc.schemedit.config.FrameworkConfigReader} as it reads the
 * configuration file for a particular framework. These SchemaPath instances are
 * stored in a {@link org.dlese.dpc.schemedit.config.SchemaPathMap} structure,
 * which is used mainly by the {@link org.dlese.dpc.schemedit.MetaDataFramework}
 * class.
 *
 * @author ostwald
 */
public class SchemaPath implements Serializable {
	 ...
	 * @param valueType
	 *            Description of the Parameter
	 * @param requiredByCopyRecord
	 *            Description of the Parameter
	 * @param readOnly
	 *            Description of the Parameter
	 * @param requiredByMinimalRecord
	 *            Description of the Parameter
	 */
	public SchemaPath(String pathName, String xpath, String defaultValue, String valueType, String inputHelper,
			String initialFieldCollapse, boolean requiredByCopyRecord, boolean readOnly,
