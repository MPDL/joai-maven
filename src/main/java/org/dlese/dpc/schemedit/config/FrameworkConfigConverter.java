...
public class FrameworkConfigConverter {
	...
	/**
	 * FrameworkConfigConverter Constructor. The dcsDataRecords param points to the
	 * root directory containing dcs_data records. the subdirectories are named for
	 * the metadata formats of the directories they contain, which in turn hold
	...
	public boolean convertFile(File file) throws Exception {
		...
		// Node paths = doc.selectSingleNode
		// ("/frameworkConfigRecord/schemaInfo/paths");
