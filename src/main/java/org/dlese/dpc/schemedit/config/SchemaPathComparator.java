...
public class SchemaPathComparator implements Comparator {
	/**
	 * sorts by order in which paths are processed by
	 * MetadataFramework.populateFields (and therefore are added to the docMap) so
	 * one value doesn't get stomped by another.
	 *
	 * @param o1
	 *            PathMap1
	 * @param o2
