 ...
 * <p>
 *
 * Used by the {@link org.dlese.dpc.schemedit.MetaDataFramework} and is required
 * for each of of the frameworks supported by DCS.
 *
 * @author ostwald
 *         <p>
 *
...
public class FrameworkConfigReader extends AbstractConfigReader {
	...
	/**
	 * Gets the rebuildOnStart attribute of the FrameworkConfigReader object. If no
	 * value is provided, or if the value is not "false", return "true".
	 *
	 ...
	 */
	/*
	 * public String getSampleRecordPath() { return
	 * getNodeText("/frameworkConfigRecord/standAloneInfo/sampleRecordPath"); }
	 */
