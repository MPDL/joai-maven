...
public class StatusFlags implements Serializable {
	 ...
	 * Description of the Field
	 */
	public final static StatusFlag UNKNOWN_STATUS_FLAG = new StatusFlag(UNKNOWN_STATUS, UNKNOWN_STATUS,
			UNKNOWN_STATUS_DESC);

	/**
	 * Description of the Field
	 */
	public final static StatusFlag NEW_STATUS_FLAG = new StatusFlag(NEW_STATUS, NEW_STATUS, NEW_STATUS_DESC);

	/**
	 * Description of the Field
	 */
	public final static StatusFlag IMPORTED_STATUS_FLAG = new StatusFlag(IMPORTED_STATUS, IMPORTED_STATUS,
			IMPORTED_STATUS_DESC);

	public final static StatusFlag RECOMMENDED_STATUS_FLAG = new StatusFlag(RECOMMENDED_STATUS, RECOMMENDED_STATUS,
			RECOMMENDED_STATUS_DESC);
	 ...
	 * FINAL_STATUS_VALUE_TEMPLATE. For example, for the collection key, "dcc", the
	 * final status value would be "_|-final-dcc-|_" "
	 *
	 * @param collection
	...
	/**
	 * Determines whether the given string is a final status value, and therefore
	 * provides a means of identifying "final status flags"
	 *
	 * @param s
	 *            Description of the Parameter
