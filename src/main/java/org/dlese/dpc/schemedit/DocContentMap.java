...
public class DocContentMap {
	 ...
	 * allows records to be compared using the Map "equals" method.
	 * <p>
	 *
	 * DocContentMaps are used to determine if a metadata has been edited in the
	 * metadata editor so the user can be warned of unsaved changes before exiting.
	 *
	 * @param doc
	 *            a {@link org.dom4j.Document} representing a metadata record
	 * @param framework
	...
	public static Map getDocContentMap(Document doc, MetaDataFramework framework) {
		...
		// string representation of "cr" that we will remove from all values, since it
		// wreaks
	 ...
	 */
	private static void compareDebug() throws Exception {
	...
	/**
	 * Utility method to generate a printable String from a given char (useful only
	 * for ASCII).
	 *
	 * @param c
	 *            Description of the Parameter
