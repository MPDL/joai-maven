 ...
 *
 * @author ostwald $Id: CollapseUtils.java,v 1.4 2005/01/28 00:15:38 ostwald Exp
 *         $
 */
public class CollapseUtils {
	 ...
	 */
	static String[][] replacementTable = {{"$", "_dollar_"}, {"{", "_leftcurly_"}, {"}", "_rightcurly_"},
			{"+", "_plus_"}, {" ", "_space_"}, {"/", "_^_"}, {"-", "_dash_"}, {":", "_colon_"}, {",", "_comma_"},
			{";", "_smcolon_"}, {"|", "_vert_"}, {"'", "_qt_"}, {".", "_dot_"},};

	/**
	 * Converts a paramName and fieldLabel to an ID that can be used in javascript.
	 * Used to support collapsible field display in metadata editor.
	 *
	 * @param paramName
	 *            Identifier used in metadata editor jsp (e.g.,
	 *            ValueOf(/itemRecord/general))
	 * @param fieldLabel
	 *            MetadataVocab Field label that identifies a field grouping within
	 *            a list of controlled vocab values
	 * @return ID suitable for use in jsp/javascript
	 */
	public static String pairToId(String paramName, String fieldLabel) {
		// prtln("pairToId with paramName:" + paramName + " and fieldLabel: " +
		// fieldLabel);
	 ...
	 * {@link org.dlese.dpc.schemedit.SchemEditUtils#pathToId} to an xpath that will
	 ...
	 * can be converted back into an xpath by
	 * {@link org.dlese.dpc.schemedit.SchemEditUtils#idToPath}
	 *
	 * @param s
