 ...
 * controls for changing the field upon which results are sorted, as well as the
 * order in which the results are sorted. A SortWidget is associated with each
 * sortable field.
 *
 * @author ostwald
 */
public class SortWidget {
	...
	public int getDefaultOrder() {
		if ((defaultOrder == Constants.DESCENDING) || (defaultOrder == Constants.ASCENDING)) {
			return defaultOrder;
		}
