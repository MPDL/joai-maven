...
public class ReferenceException extends ParseException {
	/**
	 * A string representation of a character or numerical reference (e.g., &Delta;
	 * or &#00a9;)
	 */
	public String ref;
	 ...
	 * @param msg
	 *            The reason the reference could not be resolved
	 * @param errorOffset
	 *            Offset to the unresolvable reference within the input string
	 */
