...
public class SmileEditValidator extends SchemEditValidator {
	 ...
	 *            NOT YET DOCUMENTED
	 */
	public SmileEditValidator(SchemEditForm sef, MetaDataFramework framework, ActionMapping mapping,
	...
	public SchemEditActionErrors validateForm() {
		...
		if (this.sef.getCurrentPage().equals("costTimeMaterials")) {
			...
			// find cases where a url (optional) is defined but the corresponding name
			// (required) is not.
