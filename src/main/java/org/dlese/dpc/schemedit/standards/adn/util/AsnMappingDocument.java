...
public class AsnMappingDocument extends AsnDocument {
	...
	public static void main(String[] args) throws Exception {
		// String path =
		// "/home/ostwald/python-lib/asn/standards-documents/1995-NSES-v1.2.5-localized.xml";
	...
	public void compareOne() {
		...
		// DleseStandardsNode adnStd = sm.getStandard("NSES:K-4:Content Standard F
		// Science in Personal and Social Perspectives Standards:Science and Technology
		// in Local Challenges:Science and technology have greatly improved food quality
		// and quantity, transportation, health, sanitation, and communication. These
		// benefits of science and technology are not available to all of the people in
		// the world.");
