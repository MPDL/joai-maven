...
public class TreeCache {
	 ...
	 *
	 * @param key
	 *            Document key of the form (<author>.<topic>.<year>.<uid>)
	 * @param tree
	...
	private class UsageQueue {
		...
		/**
		 * Make the supplied key the most recently used, and return the least recently
		 * used key if there are more than capacity items.
		 *
		 * @param key
		 *            Description of the Parameter
		 */
	...
	private class NodeMap {
		 ...
		 *
		 * @param key
		 *            key identifying this tree
		 * @param tree
		 *            standards tree containing nodes to be added
		 */
