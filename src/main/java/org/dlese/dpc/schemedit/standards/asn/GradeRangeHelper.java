...
public class GradeRangeHelper {
	 ...
	 *
	 * @param vocab
	 *            The feature to be added to the Item attribute
	 * @param grade
	 *            The feature to be added to the Item attribute
	 */
	...
	/**
	 * Utility class to associate a gradeRange vocab value with a label suitable for
	 * UI, and a range of gradeLevels (min and max)
	 *
	 * @author Jonathan Ostwald
	 */
	public class GradeRangeItem extends GradeRange {
		 ...
		 *
		 * @param label
		 *            a label for this gradeRange suitable for UI
		 * @param value
		 *            a value from the controlled vocab for gradeRange
		 * @param minGrade
		 *            starting grade for this gradeRange
		 * @param maxGrade
		 *            ending grade for this gradeRange
		 * @param vocab
		 *            NOT YET DOCUMENTED
		 */
