...
/**
 * Provides services for mapping between different standards formats, namely ASN
 * and ADN (dlese), as well as convenience methods for translating between the
 * different gradeRange representations.
 *
...
public class AsnToAdnMapper {
	 ...
	 *
	 * @param path
	 *            path to xml file containing mappings from ansId to ansText and
	 *            adnText
	 */
	...
	/**
	 * Converts a StandardsList into a list of suggestions represented as ADN
	 * standards
	 *
	 * @param sl
	 *            NOT YET DOCUMENTED
	 ...
	 */
	/*
	 * public List toAdnStandardsList(StandardsList sl) { List suggestions = new
	 * ArrayList(); int size = sl.getSize(); for (int i = 0; i < size; i++) {
	 * StandardWrapper wrapper = sl.getStandardAt(i); String adnText =
	 * getAdnText(wrapper.getIdentifier()); if (adnText != null)
	 * suggestions.add(adnText); else {
	 * prtln("WARNING: AsnToAdnMapper could not find ADN standard for ASF id: " +
	 * wrapper.getIdentifier()); } } return suggestions; }
	 */
	...
	public static void main(String[] args) {
		// String path =
		// "/devel/ostwald/projects/schemedit-project/web/WEB-INF/data/Adn-to-Asf-mappings.xml";
	...
	/**
	 * Returns unordered set of registered gradeRanges represented as controlled
	 * DLESE vocab (e.g., "DLESE:Primary elementary") corresponding to the grades
	 * represented by ASF standards, namely, K-12.
	 *
	...
	/**
	 * Gets the label (for UI purposes) of a gradeRange value. E.g., for the value
	 * of "DLESE:Primary elementary", the label is "Primary elementary".
	 *
	 * @param gradeRangeValue
	 *            NOT YET DOCUMENTED
