...
public class NcsAnnoFrameworkPlugin extends AsnCATPlugin {
	...
	/**
	 * initialize the NcsAnnoFrameworkPlugin object so that the suggestion service
	 * is deactivated.
	 *
	 * @param helper
	 *            the CatServiceHelper for this plugin
	 */
	...
	protected GradeRangeHelper gradeRangeHelperInit() {
		 ...
		 * grh.addItem("Pre-Kindergarten", 0); grh.addItem("Elementary School", 0, 5);
		 * grh.addItem("Early Elementary", 0, 2); grh.addItem("Kindergarten", 0);
		 * grh.addItem("Grade 1", 1); grh.addItem("Grade 2", 2);
		 * grh.addItem("Upper Elementary", 3, 5); grh.addItem("Grade 3", 3);
		 * grh.addItem("Grade 4", 4); grh.addItem("Grade 5", 5);
		 * grh.addItem("Middle School", 6, 8); grh.addItem("Grade 6", 6);
		 * grh.addItem("Grade 7", 7); grh.addItem("Grade 8", 8);
		 * grh.addItem("High School", 9, 12); grh.addItem("Grade 9", 9);
		 * grh.addItem("Grade 10", 10); grh.addItem("Grade 11", 11);
		 * grh.addItem("Grade 12", 12); return grh;
		 */
	...
	/**
	 * Gets the gradeRanges corresponding to the grades searchable in the Suggestion
	 ...
	 * "labels" are human-meaningful representations of the values. E.g., one member
	 * of the gradeRangeOption list might be (value: "1", label: "1st Grade")
	 *
