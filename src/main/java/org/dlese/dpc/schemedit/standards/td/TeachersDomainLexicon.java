 ...
 * {@link StdDocument} and {@link Standard} classes. Provides lists of
 * StandardsNodes for use in UI JSP.
 *
 * @author ostwald
 */
...
public class TeachersDomainLexicon implements StandardsDocument {
	 ...
	 *                NOT YET DOCUMENTED
	 */
	public TeachersDomainLexicon(StdDocument stdDoc) throws Exception {
