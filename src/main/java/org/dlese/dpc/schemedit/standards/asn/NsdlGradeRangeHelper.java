...
/**
 * GradeRangeHelper that accomodates the "nsdlEdLevel" vocabs, which are defined
 * by the nsdl schemas but which are also used by others, including MSP2,
 * res_qual, commcore, etc. The nsdlEdLevel vocab is a flat controlled
...
public class NsdlGradeRangeHelper extends GradeRangeHelper {
	 ...
	 * @return the lowest and highest gradeLevels in non-containing gradeRanges.
	 */
