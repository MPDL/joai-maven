...
public class AdnFrameworkPlugin extends AbstractCATHelperPlugin {
	...
	/**
	 * Gets the recordGradeRange vocab values from the instance document (i.e., the
	 * selected gradeRange vocab values)
	 *
	 ...
	 *
	 *
	 * @return A list of LabelValueBeans used to populate the GradeRange widget in
	 *         the CAT UI
	 */
