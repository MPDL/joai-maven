...
/**
 * CATServiceHelper that converts ASN standards to ADN representation and back
 * for use with the ADN metadataFramework.
 *
 * @author ostwald
 */
public class DleseSuggestionServiceHelper extends CATServiceHelper {
	 ...
	 *
	 * @param sef
	 *            SchemEditForm instance
	 * @param servletContext
	 *            ServletContext providing access to suggestion service and
	 *            asfToAdnMapper
	 */
	...
	/**
	 * Returns the AdnText corresponding to the provided standard's identifier (via
	 * the standardsMapper instance).
	 *
	 * @param std
	 *            NOT YET DOCUMENTED
	...
	public static void main(String[] args) {
		...
		/*
		 * c.setStartGrade(helper.getStartGrade()); c.setEndGrade(helper.getEndGrade());
		 */
		prtln(c.toString());
