...
/**
 * Represents an controlled vocabulary item from the ADN educational metadata
 * standard. ADN represents standards as strings delimited by semi-colons, which
 * serve to break the text up into "levels". This class provides access to the
...
public class AdnStandard {
	 ...
	 * used to define this vocab item. The text attribute is colon-delimited to
	 * express hierarchical relations.
	 *
	...
	public class StandardComparator implements Comparator {
		...
		public int compare(Object o1, Object o2) {
			/*
			 * System.out.println ("hello"); String string1 = ((AdnStandard)
			 * o1).getId().toLowerCase(); String string2 = ((AdnStandard)
			 * o2).getId().toLowerCase(); return string2.compareTo(string1);
			 */
			return 0;
		}
	}
