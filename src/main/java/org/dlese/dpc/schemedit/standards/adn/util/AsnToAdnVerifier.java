...
/**
 * verifies that the asn and adn standards represented in the mappings file
 * correspond to the asn and adn standards.
 * <p>
 *
 * adnManager: adn standards read from framework schema asnManager: asn
 * standards read from localized standardsDocument asn2adnMap: read from
 * mappingsFile
 *
...
public class AsnToAdnVerifier {
	...
	/**
	 * Test whether there is a mapping for each NSES adn standard of level 3 and 4.
	 * <p>
	 *
