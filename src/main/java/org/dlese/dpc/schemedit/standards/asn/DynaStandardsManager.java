...
public class DynaStandardsManager extends AsnStandardsManager {
	 ...
	 *
	 * @param xpath
	 *            xpath of instanceDoc to which standards are assigned
	 * @param xmlFormat
	 *            format of framework for this helper
	 * @param standardsDirectory
	 *            path to directory containing standardsDocs
	 * @param defaultDocKey
	 *            as configured for this helper
	 * @exception Exception
	 *                if AsnDocument files cannot be processed
	 */
	public DynaStandardsManager(String xmlFormat, String xpath, File standardsDirectory, String defaultDocKey)
		...
		/*
		 * defaultDocKey is not necessarily a complete key (i.e., "author.topic." vs
		 * "author.topic.year") - try to match defaultDocKey and if there is no match
		 * simply pick the first available standards doc configured for this helper.
		 */
		try {
	 ...
	 * @exception Exception
	 *                if standards docs cannot be loaded into StandardsRegistry
	 */
