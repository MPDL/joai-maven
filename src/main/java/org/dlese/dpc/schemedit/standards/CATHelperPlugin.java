...
public interface CATHelperPlugin {
	...
	/*
	 * -------- INSTANCE DOC values for use in UI ------------ these methods get the
	 * values to be used in the CAT UI. They don't necessarily have to correspond to
	 * single fields in the instance doc. For example, the getRecordKeywords()
	 * method for the msp2 framework actually grabs the subject values as well as
	 * the keyword values from the instance doc
	 */
	/**
