...
/**
 * Helper class to provide information about the currently selected standards in
 * the UI, which may span several standards documents. The "docKey" attribute is
 * settable by the UI, which enables information about a specific document (and
 * its selected standards) to be queried.
 *
 * @author ostwald
 */
...
public class SelectedStandardsBean {
	 ...
	 *
	 * @param selectedStandards
	 *            standards currently selected in the UI
	 * @param currentDocKey
	 *            key (e.g., "NSES.Science.1995.D10001D0") of standards document
	 ...
	 *
	 * @param selectedStandards
	 *            list of stds selected in UI
	 * @param currentDocKey
	 *            docKey (e.g., "NSES.Science.1995.D10001D0")
	 */
	public void update(List selectedStandards, String currentDocKey) {
		...
		// we update nodeMap if nodeMap is currently null or if selectedStandards has
		// changed
	...
	static String[] debugIds = {"http://purl.org/ASN/resources/S102DBAE", "http://purl.org/ASN/resources/S103E0D7",
			"http://purl.org/ASN/resources/S103EC5A", "http://purl.org/ASN/resources/S103EC5B",
			"http://purl.org/ASN/resources/S1027384", "http://purl.org/ASN/resources/S102747E"};

	static String[] sampleIds = {"http://purl.org/ASN/resources/S102DBAE", "http://purl.org/ASN/resources/S103E0D7",
			"http://purl.org/ASN/resources/S103EC5A", "http://purl.org/ASN/resources/S103EC5B",
			"http://purl.org/ASN/resources/S1027384", "http://purl.org/ASN/resources/S102747E",
			"http://purl.org/ASN/resources/S103E0D7", "http://purl.org/ASN/resources/S103EC5A",
			"http://purl.org/ASN/resources/S103EC5B", "http://purl.org/ASN/resources/S1027384",
