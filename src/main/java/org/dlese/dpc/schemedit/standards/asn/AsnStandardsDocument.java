...
public class AsnStandardsDocument implements StandardsDocument {
	 ...
	 *                NOT YET DOCUMENTED
	 */
	public AsnStandardsDocument(AsnDocument asnDoc) throws Exception {
	...
	/**
	 * Create a hierarchical tree of AsnStandardsNodes by splitting up the Standards
	...
	public static void main(String[] args) throws Exception {
		...
		// String filename = "1995-National Science Education Standards
		// (NSES)-Science-National Science Education Standard.xml";
