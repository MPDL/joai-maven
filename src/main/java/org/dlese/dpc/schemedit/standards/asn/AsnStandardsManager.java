...
public class AsnStandardsManager implements StandardsManager {
	 ...
	 *
	 * @param xmlFormat
	 *            format of framework for this standardsManager
	 * @param xpath
	 *            field for which standards are managed
	 * @param source
	 *            AsnDocument file
	 * @exception Exception
	 ...
	 * from the provided AsnDocument file.
	 *
	 * @param source
	 *            AsnDocument file
	 * @exception Exception
	 *                if the source file cannot be processed
	 */
	...
	/**
	 * Gets the availableDocs (avaliable ASN Standards Documents) attribute of the
	 * AsnStandardsManager object
	 *
