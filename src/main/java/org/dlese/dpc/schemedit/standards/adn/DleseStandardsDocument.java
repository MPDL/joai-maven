...
public class DleseStandardsDocument implements StandardsDocument {
	...
	public static void main(String[] args) {
		...
		// String item = "NSES:K-4:Unifying Concepts and Processes Standards:Systems,
		// order, and organization";
		// String item = "NSES:5-8:Content Standard D Earth and Space Science
		// Standards:Structure of the earth system:Land forms are the result of a
		// combination of constructive and destructive forces. Constructive forces
		// include crustal deformation, volcanic eruption, and deposition of sediment,
		...
		/*
		 * List ancestors = n.getAncestors(); prtln (ancestors.size() +
		 * " ancestors found for \t" + item); for (Iterator
		 * i=ancestors.iterator();i.hasNext();) { DleseStandardsNode a =
		 * (DleseStandardsNode)i.next(); prtln ("\t" + a.getId() + " (" + a.getLevel() +
		 * ")"); }
		 */
	}
