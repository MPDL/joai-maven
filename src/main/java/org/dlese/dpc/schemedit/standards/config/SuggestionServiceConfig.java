...
/**
 * Encapsulates configuration for a suggestion service, incuding the framework
 * that the service operates for and what standards files are to be used for
...
public class SuggestionServiceConfig {
	 ...
	 *
	 * @param config
	 *            A element form a standards config file
	 */
	...
	/**
	 * Gets the standardsDirectory attribute of the SuggestionServiceConfig object,
	 * which designates a directory containing standards files.
	 *
