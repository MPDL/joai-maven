 ...
 * <p>
 *
 * These plugins make use of a {@link GradeRangeHelper} to map GradeRange vocabs
 * defined in the schema to corresponding CAT API constraints.
 *
 * @author ostwald
 */
public abstract class AsnCATPlugin extends AbstractCATHelperPlugin {
	 ...
	 *            value in the CAT UI
	 * @return The gradeLevelOptionValue, or -1 if the provided value could not be
	 *         processed as a CAT UI value.
	 */
	...
	/**
	 * Returns the lesser of the selected gradeLevel constraints selected in the CAT
	 * UI (as an integer).
	 * <p>
	 *
	 * NOTE: Assumes CAT UI specifies two constraints, and that both can be parsed
