...
public class StandardsMappingInfoMaker {
	...
	/**
	 * Create an xml document containing an element for each 4th level standard. The
	 * standards elements have the following attributes:
	 * <ul>
	 * <li>id (asnID)
	 * <li>adnText (text of the ADN vocab)
	 * <li>asnText (text derived from ASN node's "itemDescription" plus that of it's
	 * ancestors). this resembles the adnText, but is not the same string
	 * </ul>
	 */
