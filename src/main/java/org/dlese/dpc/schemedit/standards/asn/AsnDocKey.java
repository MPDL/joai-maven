...
public class AsnDocKey {
	 ...
	 * authors to NSES author values to overcome inconsistencies between CAT and ASN
	 * naming conventions for authors (aka, jurisdiction).
	 *
	 * @param author
	 *            the author
	 * @param topic
	 ...
	 *            the created
	 * @param uid
	 *            unique part of asn id (e.g., "D10001D0")
	 */
	public AsnDocKey(String author, String topic, String created, String uid) {
		// for NSES, CAT service requires a different value for author than the ASN doc
		// contains ...
	...
	/**
	 * Returns a AsnDocKey instance created from provided docKeyAsString value
	 * (e.g., "NSES.Science.1995.D10001D0")
	 */
