...
/**
 * Provides acess to a single CommCore Standards Document (and individual
 * standards contained within) via the {@link StdDocument} and {@link Standard}
...
public class CommCoreStandardsDocument implements StandardsDocument {
	 ...
	 *            StdDocument file
	 * @exception Exception
	 *                if StdDocument file cannot be processed
	 */
	...
	/**
	 * Initialize the CommCoreStandardsDocument by populating the standardsMap and
	 * tree
	 *
	 * @param stdDoc
	 *            NOT YET DOCUMENTED
	...
	/**
	 * Flattens the hierarchy under the given CommCoreStandardsDocument list, and
