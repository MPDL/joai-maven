...
/**
 * Bean to store the min and max grade levels associated with a controlled vocab
 * expressing a grade range.
 *
...
public class GradeRange {
	...
	/**
	 * Determines if the extents of this GradeRange contain those of provided
	 * gradeRange.
	 *
	 * @param other
	 *            other GradeRange
	...
	public boolean contains(GradeRange other) {
		return (this.minGrade <= other.minGrade && this.maxGrade >= other.maxGrade);
	}
