 ...
 * {@link org.dlese.dpc.schemedit.action.form.StaticRecordForm} Struts form bean
 * class.
 *
 *
 *
...
public final class StaticRecordAction extends DCSAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		try {
			...
			if (id != null && id.length() > 0) {
				...
				errors.add("message",
						new ActionError("generic.message", "No ID indicated. Please supply a record ID."));
				saveErrors(request, errors);
	...
	private ActionForward viewRecordById(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		 ...
		 * srForm.setSchemaHelper(framework.getSchemaHelper()); srForm.setDocMap(doc);
		 */
