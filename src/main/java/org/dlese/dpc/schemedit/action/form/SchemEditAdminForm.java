...
public class SchemEditAdminForm extends ActionForm {
	 ...
	 */
	/*
	 * public FormFile getSampleFile() { return sampleFile; }
	 */
	 ...
	 *
	 * @param sampleFile
	 *            The new sampleFile value
	 */
	/*
	 * public void setSampleFile(FormFile sampleFile) { this.sampleFile =
	 * sampleFile; }
	 */
	 ...
	 * Necessary because we need to send user back to either the stand-alone editor
	 * or the DCS
	 *
	 * @param editorMode
	 *            The new editorMode value
	 */
	...
	/**
	 * Gets the editorMode attribute of the SchemEditAdminForm object (Stand-alone
	 * or DCS).
	 *
	 ...
	 *
	 * @param s
	 *            The new sampleRecordFile value
	 */
	 ...
	 * inside of this validate method.
	 *
	 * @param mapping
	...
	public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
		...
		if ((maxLengthExceeded != null) && (maxLengthExceeded.booleanValue())) {
			errors.add("pageErrors", new ActionError("admin.maxLengthExceeded"));
		}
		...
		if (scheme.equals("file")) {
			...
			if (file == null || !file.exists()) {
				...
				errors.add("schemaURI", new ActionError("generic.error", "warning: file does not exist"));
				return errors;
			}
