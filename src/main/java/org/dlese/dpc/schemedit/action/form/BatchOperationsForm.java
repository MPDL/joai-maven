 ...
 * {@link org.dlese.dpc.schemedit.action.BatchOperationsAction}.
 *
 */
public class BatchOperationsForm extends ActionForm {
	 ...
	 *
	 * @param results
	 *            The new failedRecordList value
	 */
	...
	/**
	 * Clears the status attributes (editor, status, statusNote) for batch status
	 * change.
	 */
