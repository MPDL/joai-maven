...
public final class DCSViewForm extends SchemEditForm implements Serializable {
	...
	/**
	 * Get the index of the current result within the results. Returns -1 if result
	 * not found.
	 */
	...
	public SchemEditActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
