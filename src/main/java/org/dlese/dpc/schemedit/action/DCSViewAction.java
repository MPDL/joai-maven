 ...
 * conjunction with the {@link org.dlese.dpc.schemedit.action.form.DCSViewForm}
...
public final class DCSViewAction extends DCSAction {
	...
	private ActionForward viewCollectionConfig(ActionMapping mapping, ActionForm form, HttpServletRequest request,
	...
	private ActionForward viewFrameworkConfig(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
	...
	private ActionForward viewRecordById(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if (result == null) {
			viewForm.setResult(null);
			errors.add("message",
					new ActionError("generic.message", "No record was found in the index for ID \"" + id + "\""));
			saveErrors(request, errors);
			return mapping.findForward("view.record");
		}
		...
		if (framework == null) {
			viewForm.setResult(null);
			errors.add("error",
					new ActionError("generic.message", "Framework is not loaded for format \"" + xmlFormat + "\""));
		}
