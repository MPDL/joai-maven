...
/**
 * Controller for the DcsDataFramework editor. As a stand-alone schemedit
 * action, this supports framework-config files to be created and edited in a
 * particular directory, and is not connected to the index or repository.
 *
 * @author ostwald
 *         <p>
 *         $Id: FrameworkConfigAction.java,v 1.6 2009/03/20 23:33:55 jweather
 *         Exp $
 */
public final class FrameworkConfigAction extends StandAloneSchemEditAction {
	...
	/**
	 * Place the name of the edited framework in the request before calling
	 * super.execute.
	 */
	...
	/*
	 * Overides super putRecord to decouple file name from xmlFormat. As a
	 * standalone editor, this class obtains the xmlFormat of the framework config
	 * records through the request's "recId" parameter. But we don't want to force
	 * files to be named according to the format. Instead, the source file is stored
	 * in the FrameworkConfigReader instance for this framework.
	 */
	...
	/*
	 * Obtain the config file using the xmlFormat to query the
