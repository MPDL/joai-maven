...
/**
 * Same purpose as
 * {@link org.dlese.dpc.schemedit.vocab.integrity.IntegrityChecker}, but works
 * over files in the framework-project, rather than the MUI.
 *
 * @author ostwald
 *         <p>
 *
...
public class IntegrityChecker {
	 ...
	 * gather information about the frameworks we want to check. We check the fields
	 * files for the specified frameworks against the schemas that are also
	 * specified in the frmameworks.xml files. the schemas can be within the
	 * frameworks-project or they may reside at any URI
	 *
	 * @param frameworksFilepath
	 *            file containing information about the frameworks to check
	 * @exception Exception
	 *                NOT YET DOCUMENTED
	 */
	 ...
	 *
	 * @param versionDir
	 *            a framework/version directory within the frameworks project (e.g.,
	 *            adn/0.6.50)
	 * @param rootElement
	 *            NOT YET DOCUMENTED
	 * @param schemaURI
	 ...
	 * schema.
	 *
	 * @param frameworkElement
	 *            element from framework.xml file
	 * @exception Exception
	 *                NOT YET DOCUMENTED
	 */
	 ...
	 * files are found using the "dir" parameter, and the schema is found using the
	 * "uri" parameter. The schema may be local or at a web address.
	 *
	 * @param name
	 *            framework name (e.g., 'adn')
	 * @param dir
	 *            location of fields file listing
	 * @param uri
	 *            specifies SchemaURI (can be absolute or relative)
	 * @param rootElement
	 *            required to instantiate schemaHelper
	 * @exception Exception
	 *                NOT YET DOCUMENTED
	 */
	void processFramework(String name, String dir, String uri, String rootElement) throws Exception {
		...
		/*
		 * prtln("\nPROCESS FRAMEWORK"); prtln("\t name: " + name); prtln("\t dir: " +
		 * dir); prtln("\t uri: " + uri); prtln("\t rootElement: " + rootElement);
		 */
		URI schemaUri;
		...
		// Framework Directory is of the form:
		// frameworks-project/frameworks/<format>/<version>/
		...
		/*
		 * prtln(Utils.line(20, "+")); prtln("Processing Framework (" + name + " - " +
		 * frameworkDir + ") ...");
		 */
		if (this.truncate) {
			prtln("\nTRUNCATED ... returning");
	...
	public static void main(String[] args) {
		...
		// defaults - get overridden if there is a param passed by caller (which there
		// always should be)
