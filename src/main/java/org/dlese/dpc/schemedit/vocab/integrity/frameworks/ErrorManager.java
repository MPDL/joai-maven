...
class ErrorManager {
	...
	void initErrorTypes() {
		...
		errorTypes.put(FieldFilesChecker.READER_ERROR, new ErrorType(FieldFilesChecker.READER_ERROR, "Reader Error",
				"This file does not exist or could not be read as XML"));

		errorTypes.put(FieldFilesChecker.ILLEGAL_PATH, new ErrorType(FieldFilesChecker.ILLEGAL_PATH, "Illegal Path",
				"This file defines an xpath that is not schema-legal"));

		errorTypes.put(FieldFilesChecker.MISSING_PATH,
				new ErrorType(FieldFilesChecker.MISSING_PATH, "Missing Path", "NOT defined in any field file"));

		errorTypes.put(FieldFilesChecker.DUPLICATE_PATH, new ErrorType(FieldFilesChecker.DUPLICATE_PATH,
				"Duplicate Path", "Contained in mulitiple fields files"));

		errorTypes.put(FieldFilesChecker.MISSING_VOCAB,
				new ErrorType(FieldFilesChecker.MISSING_VOCAB, "Missing Vocab", "Schema vocab terms NOT defined"));

		errorTypes.put(FieldFilesChecker.DUPLICATE_VOCAB,
				new ErrorType(FieldFilesChecker.DUPLICATE_VOCAB, "Duplicate Vocab Terms", "defined more than once"));
	}
