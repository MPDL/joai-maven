...
/**
 * Populates a {@line FieldInfoMap} by reading from a file specified in
 * Framework config file (with name ending in "filename-list.xml"). The
 * filename-list file contained:
 * <ul>
 * <li>a directoryURL - pointing to a directory where the individual fields
 * files would be located
 * <li>a list of file names that were appended to the directoryURL to access the
 * individual fields files.
 *
 * </ul>
 * An example filename-list file can be found at:
 * http://www.dlese.org/Metadata/adn-item/0.6.50/build/filename-list.xml
 *
 * @author ostwald
 *
 */
