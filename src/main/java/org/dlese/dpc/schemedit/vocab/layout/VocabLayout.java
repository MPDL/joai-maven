...
public class VocabLayout {
	 ...
	 * @exception Exception
	 *                if vocabLayout file cannot be processed
	 */
	...
	/**
	 * Returns all layout nodes calculated by flattening the hierarchy of
	 * layoutNodes into a list.
	 *
	 ...
	 *
	 * @param nodeList
	 *            list of LayoutNodes to be processed
	 * @return The nodeList value
	 */
	...
	public static void main(String[] args) throws Exception {
		...
		// VocabLayout docReader = new VocabLayout
		// ("http://localhost/vocabLayoutTest/groups/resourceType-adn-groups-cataloger-en-us.xml");
