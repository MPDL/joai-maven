...
public class SIFFieldInfoWriter {
	 ...
	 *
	 * @param basePath
	 *            directory into which fields files are written
	 * @exception Exception
	 ...
	 * @exception Exception
	 *                if there is a problem with the xpath or document creation
	 */
	...
	/**
	 * convert from schema location to the location of data model schema. only works
	 * for SIF
	 * 
	 * xsdLoc:
	 * http://www.dls.ucar.edu/people/ostwald/Metadata/sif/InstructionalServices/Activity.xsd
	 * dataModelLoc:
	 * http://www.dls.ucar.edu/people/ostwald/Metadata/sif/DataModelAnnotated/InstructionalServices/Activity.xsd
	 */
	...
	void setSIFDefinition(Document doc) {
		...
		/*
		 * prtln ("\n---- schemaNode ----"); prtln (schemaNode.toString()); prtln
		 * ("----------");
		 */
		...
		if (parent != null) {
			/*
			 * prtln ("\n---- parentNode ----"); prtln (parent.toString()); prtln
			 * ("----------");
			 */
		} else {
			return;
	 ...
	 */
	/*
	 * Document getWritableDoc() throws Exception { return
	 * fieldsFramework.getWritableRecord(doc); }
	 */
