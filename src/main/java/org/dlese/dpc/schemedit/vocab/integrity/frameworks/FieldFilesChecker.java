...
public class FieldFilesChecker {
	...
	/**
	 * Constructor for the FieldFilesChecker object, for a given framework (e.g.,
	 * adn/0.6.50). Checks fields files for constistency with schema.
	 *
	 * @param frameworkDir
	 *            Path within framework project to a particular version of a
	...
	/**
	 * Initialize the various lists that are used to hold errors so they can be
	 * reported
	 */
