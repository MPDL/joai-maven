...
/**
 * A node in a VocabLayout tree as defined by a vocabLayout (historically called
 * "groups") file.
 *
...
public class LayoutNode {
	 ...
	 *
	 * @param element
	 *            element defining this LayoutNode in the vocabLayout file
	 * @param vocabLayout
	 *            the vocabLayout instance of which this node is a member
	 */
	 ...
	 *            the vocabLayout instance of which this node is a member
	 * @param parent
	 *            the parent LayoutNode instance
	 */
	...
	/**
	 * Gets the wrap attribute of the LayoutNode object, used to create a new column
	 * in the display.
	 *
	...
	/**
	 * Gets the noDisplay attribute of the LayoutNode object, suppresses display of
	 * this LayoutNode.
	 *
	...
	/**
	 * Gets the sibling LayoutNode (including this one) of this LayoutNode instance.
	 *
	...
	/**
	 * Gets the groupLevel attribute of the LayoutNode object, which specifies the
	 * depth of this LayoutNode within the VocabLayout tree.
	 *
