...
/**
 * Populates the a groupInfoMap by reading from a file specified in Framework
 ...
 * URI to the individual fields files.
 * <p>
 *
 * E.g.,
 * <ul>
 * <li>the fields-list for dlese_anno format is
 * http://www.dlese.org/Metadata/annotation/1.0.00/build/fields-list.xml.
 *
 * <li>within the fields-list file a relative URI is:
 * annotation/1.0.00/fields/annotation-anno-fields-en-us.xml
 *
 * <li>the absolute uri to this field file is:
 * http://www.dlese.org/Metadata/annotation/1.0.00/fields/annotation-anno-fields-en-us.xml.
 * The resolution of absolute Uris is done in
 * {@link #getFieldsFileUri(URI, String)}.
 * </ul>
 *
 *
 * @author ostwald
...
public class VocabLayoutConfig {
	...
	/**
	 * Read a listing of URIs Fields files from directoryUri and then loads each of
	 * the listed files as VocabLayout objects, which are stored in a map.
	 *
	 * @exception Exception
	 *                Description of the Exception
	 */
	...
	/**
	 * Gets an absolute URI be resolving a baseUri (pointing to the groups-list
	 * file) and a relativePath.
	 * <p>
	 *
	 * The first two parts of the relative path form a format, version key. E.g. for
	 * relativePath "annotation/1.0.00/fields/annotation-anno-fields-en-us.xml" the
	 * key is "annotation", "1.0.00". To form an absolute fieldsFileUri, the part of
	 * the baseUri above the key are joined with the relativePath.
	 * <p>
	 *
	 ...
	 *
	 * @param baseUri
	 *            baseUri pointing to a fields-list file
	 * @param relativePath
	 *            a relative path containing a framework, version key and the name
	 *            of the fields file.
	 * @return an absolute groupsFileUri
	 * @exception Exception
	 *                if absoluteFieldsFileUri cannot be computed
	 */
	public URI getFieldsFileUri(String relativePath) throws Exception {
		...
		// the first two levels of the relativePath are the key - they specify
		// frameworkName and version
		String[] relativeSplits = relativePath.split("/");
		if (relativeSplits.length < 3)
			throw new Exception(
					"illegal relative path (\"" + relativePath + "\") - at least 3 segements are required: ");
		...
		if (x == -1)
			throw new Exception(
					"framework/version key (\"" + key + "\") not found in baseUri (\"" + configPath + "\")");
	...
	public static void main(String[] args) throws Exception {
		...
		// String path =
		// "/Users/ostwald/devel/projects/metadata-ui-project/frameworks/adn-item/0.6.50/build/groups-list.xml";
		...
		// Settings/ostwald/devel/projects/metadata-ui-project/frameworks/adn-item/0.6.50/build/my-groups-list.xml";
