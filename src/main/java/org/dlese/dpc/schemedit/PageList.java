...
/**
 * Manages information about the editor pages in support of SchemaEdit. PageList
 * is created {@link org.dlese.dpc.schemedit.config.FrameworkConfigReader},
...
public class PageList implements Serializable {
	...
	public class Page {
		 ...
		 *
		 * @param mapping
		 *            the key into the action mapping to display this page
		 * @param name
		...
		/**
		 * Gets the name attribute of the Page object, defaulting to mapping attribute
