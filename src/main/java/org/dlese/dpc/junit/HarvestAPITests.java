...
public class HarvestAPITests extends TestCase {
	...
	public void test_OAIChangeListener() throws Exception {
		...
		String[][] res = harvester.doHarvest(baseURL, metadataPrefix, setSpec, from, until, outdir, splitBySet, zipName,
				zipDir, writeHeaders, harvestAll, harvestAllIfNoDeletedRecord);
