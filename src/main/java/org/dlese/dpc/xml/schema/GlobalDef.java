...
/**
 * Interface for classes encapsulating XML Schema Elements, such as Elements,
 * Attributes, and Type Definitions. There are two "families" of GlobalDefs:
 * type definitions and declarations. Type definitions include GenericType,
 * BuiltInType, SimpleType and ComplexType. Global Declarations include
 * GlobalElement and GlobalAttributes.
 *
 * @author ostwald
 *         <p>
 *         $Id $
...
public interface GlobalDef {
	...
	/**
	 * Returns an integer contant that specifies whether this GlobalDef is Generic,
	 * Simple, Complex, Global or Built-in datatype.
	 *
	...
	/**
	 * Returns string representation of the Global Def's dataType (e.g.,
	 * "simpleType", "complexType", etc).
	 *
	...
	/**
	 * Returns the dataType name for this GlobalDef (e.g., "union.dateType",
	 * "stringTextType", etc).
	 *
	...
	/**
	 * use prefix for namespace as defined at the instance level. NOTE: namespaces
	 * may not be defined at the instance level!
	 */
	public String getQualifiedInstanceName();

	/**
	 * Returns string representation of URI to the schema file in which this
	 * GlobalDef is defined.
	 *
