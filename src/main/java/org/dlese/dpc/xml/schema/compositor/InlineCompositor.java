...
/**
 * InlineCompositor class specifies methods for accessing and validating the
 * "members" of a InlineCompositor Element (i.e., All, Sequence and Choice), as
 * well as the acceptsNewMember method. The members are a list of
 * CompositorMember instances which represent the child elements of the
 * InlineCompositor element.
 *
 * 
 * @author ostwald
 */
public class InlineCompositor extends Compositor {
	...
	/**
	 * Returns an integer contant that specifies whether this InlineCompositor is
	 * Sequence, Choice, All.
	 *
	 ...
	 * according to schema-defined constraints for this InlineCompositor.
	 *
	 * 
