...
public class Choice extends Compositor {
	...
	/**
	 * Returns true if instances of this compositor Must have at least one member. A
	 * Choice compositor need not have a member if the compositor has minOccurs of 0
	 * OR if one of the choices has minOccurs of 0.
	 * <p>
	 * NOTE: this is much simpler than calculating how many members are ultimately
	 * required ....
	 */
