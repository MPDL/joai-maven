...
/**
 * Wrapper for AttributeGroup definitions in an XML Schema, which are defined as
 * an immediate child of the schema element.
 * <p>
 *
 * AttributeGroup definitions are associated with a type in one of the following
 * ways:
 * <ul>
...
public class AttributeGroup extends GlobalDeclaration {
	...
	public void extractDocumentation() {
		Element docElement = (Element) this.element.selectSingleNode(
				this.xsdPrefix + ":attribute/" + this.xsdPrefix + ":annotation/" + this.xsdPrefix + ":documentation");
		if (docElement != null) {
