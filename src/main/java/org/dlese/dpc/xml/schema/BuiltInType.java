...
/**
 * wrapper for BuiltInType definitions ({@link org.dom4j.Element}). filters out
 * annotation elements for now
 */
public class BuiltInType extends GenericType {
	/*
	 * protected String name; protected String location; protected Element element;
	 * protected String path; protected String type; protected Namespace namespace;
