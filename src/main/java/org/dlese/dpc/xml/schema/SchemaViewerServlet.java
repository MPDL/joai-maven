...
public final class SchemaViewerServlet extends HttpServlet {
	...
	public void init(ServletConfig conf) throws ServletException {
		...
		/*
		 * RemoteSearcher rs = (RemoteSearcher) servletContext.getAttribute
		 * ("RemoteSearcher"); if (rs == null) { throw new ServletException
		 * ("RemoteSearcher not found in servlet context"); }
		 */
