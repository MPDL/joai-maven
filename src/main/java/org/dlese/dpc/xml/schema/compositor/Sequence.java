...
public class Sequence extends Compositor {
	 ...
	 * 
	 * NOTE: this method does not make sense! What we are interested in, is which of
	 * the CompositorMembers can accept another occurrence!
	 */
	...
	/**
	 * Does the the given instanceElement accept a specifical new member at a
	 * specific location?
	 * 
	 * WHEN would this be called? Compositors only care whether they can accept
	 * another OCCURRENCE!
	 */
