 ...
 *
 *         $Id $
 * @version $Id: SchemaNamespaceConverter.java,v 1.3 2009/03/20 23:34:01
 *          jweather Exp $
 */
public class SchemaNamespaceConverter {
	...
	/**
	 * Test that the original schema namespace is indeed the default namespace -
	 * namely, it has no prefix and the namespaceURI matches SCHEMA_NAMESPACE_URI.
	 */
	...
	public static void main(String[] args) throws Exception {
		...
		// String path =
		// "/Library/WebServer/Documents/metadata-frameworks/nsdl-oai/oai_dc.xsd";
