...
/**
 * Wrapper for global delclarations in an XML Schema, which are defined as an
 * immediate child of the schema element.
 * <p>
 * Global Declarations do NOT define a data type or model, but they do define a
 * construct that can be referred to by other schema elements via the "ref"
 * attribute.
 *
...
public class GlobalDeclaration implements GlobalDef {
	...
	public GlobalDeclaration(Element element, String location, Namespace namespace, SchemaReader schemaReader) {
		...
		/*
		 * else filterChildren(xsdPrefix + ":annotation");
		 */
	...
	public void extractDocumentation() {
		Element docElement = (Element) this.element
				.selectSingleNode(this.xsdPrefix + ":annotation/" + this.xsdPrefix + ":documentation");
		if (docElement != null) {
