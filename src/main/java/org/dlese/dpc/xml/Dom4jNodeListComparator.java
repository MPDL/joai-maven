...
/**
 * Compares two dom4j nodes using an xPath. Note that a dom4j Node List can be
 * sorted using the native method:
 * <code>List sortedList = document.selectNodes("/ListSets/set","setName");</code>
 *
 * @author John Weatherley
 * @version $Id: Dom4jNodeListComparator.java,v 1.2 2009/03/20 23:34:01 jweather
 *          Exp $
 */
public class Dom4jNodeListComparator implements Comparator {
	 ...
	 * @param xPath
	 *            An xPath relative to the node root
	 * @see #ASCENDING
	 * @see #DESCENDING
	 */
