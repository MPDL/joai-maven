...
/**
 * A simple demonstraion implementation of the {@link XMLFormatConverter}
 * interface. Just appends a comment to the end of the XML content. Can be used
 * on any XML format for demonstration and testing.
 *
...
public class SimpleXMLFormatConverter implements XMLFormatConverter {
	...
	/**
	 * Performs XML conversion from the input format to the output format by simply
	 * adding a coment to the end of the input XML record.
	 *
	 * @param xml
