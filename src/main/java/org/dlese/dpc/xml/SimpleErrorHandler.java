...
/**
 * A simple XML error handler that catches XML errors and warnings and saves
 * them to StringBuffers so the errors can be extracted and displayed.
 *
...
public class SimpleErrorHandler extends DefaultHandler implements LexicalHandler {
	 ...
	 *
	 * @param errorBuff
	 *            A StringBuffer that will capture error messages, if present.
	 * @param warningBuff
	 *            A StringBuffer that will capture warning messages, if present.
	 */
