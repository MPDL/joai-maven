...
/**
 * Provided here only to support the DLESE metadata object types required by the
 * the DleseXMLReader class. This scaled-down version removes most of the
...
public class DleseBean {
	 ...
	 *
	 * @param value
	 *            The new otherTechnicalInfo value
	 */
	...
	/**
	 * Provides an object definition for representing the technical requirements of
	 * a DLESE resource, as specified by the DLESE metadata framework.
	 * <p>
	 *
	 *
	 *
	...
	/**
	 * Provides an object definition for representing the learning resource types of
	 * a DLESE resource, as specified by the DLESE metadata framework.
	 *
	 * @author Dave Deniman
	 * @version 1.0, 02/01/01
	...
	/**
	 * Provides an object definition for representing a contributor as specified by
	...
	public static class Contributor implements Serializable {
		...
		public boolean isEmpty() {
			if ((getValue("role").length() > 0)
					&& ((getValue("lastname").length() > 0) || (getValue("org").length() > 0))) {
				return false;
			}
			return true;
		}
		...
		public String name() {
			...
			buf.append(getValue("title")).append(' ').append(getValue("firstname")).append(' ').append(getValue("mi"))
					.append(' ').append(getValue("lastname")).append(' ');
			return buf.toString();
		}
	...
	/**
	 * Provides an object definition for representing an annotation as specified by
	 * the DLESE metadata framework.
	 *
	 * @author Dave Deniman
	 * @version 1.0, 02/01/01
	...
	/**
	 * Provides an object definition for representing a relation as specified by the
	...
	public static class GeoReference implements Serializable {
		 ...
		 */
		public boolean isEmpty() {
			if (((getValue("north").length() > 0) && (getValue("east").length() > 0) && (getValue("south").length() > 0)
					&& (getValue("west").length() > 0))
					|| ((getValue("begintime").length() > 0) || (getValue("begindate").length() > 0)
