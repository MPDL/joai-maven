 ...
 * <p>
 *
 * The accessor methods act as an interface with the {@link XMLNode} and
 * {@link XMLRecord} classes. The XML processing details are handled by those
 * classes, but the one requirement of this class is to have knowledge of the
 * paths structure. Paths are used as keys into the <tt>XMLRecord</tt> map.
 *
 * @author Dave Deniman
 * 
...
public class DleseXMLReader implements XMLMap {
	...
	/**
	 * Default constructor is restricted to assure that a file directory is provided
	 * on object creation.
	 */
	...
	/**
	 * @param filepath
	 *            A qualified filepath to a well-formed XML file.
	 */
	...
	/**
	 * Creates <tt>XMLRecord</tt> and intializes local map. If an error occurs then
	 * an error message may be obtained by immediately calling the getInitErrorMsg()
	 * method.
	 *
	...
	public boolean init() {
		...
		try {
			...
			// System.err.println( this.getClass() + " threw exception with message: " +
			// t.getMessage() );
			// t.printStackTrace();
	...
	/**
	 * Gets a message describing the initialization error or empty string if no
	 * error occured.
	 *
	 ...
	 *
	 * @param name
	 *            the user-defined name identifying the specific value to retrieve.
	 ...
	 *
	 * @param name
	 *            the user-defined name identifying the specific value to update.
	 * @param xmlObject
	 *            the value to assoicate with the specified name.
	 */
	 ...
	 *
	 * @param key
	 *            The path for the desired node.
	 * @param identifier
	 *            A string used to identify the specific comment.
	...
	/**
	 * Retrieves the additional information from the footnote comment of the current
	 * record.
	 *
	...
	protected List getAudiences() {
		/*
		 * NOTE: sets up the basic algorithm used by all the following methods...
		 */
	...
	protected List getSubjects() {
		...
		if (num > 0) {
			...
			for (int i = 0; i < num; i++) {
				key.delete(0, key.length());
				key.append("record:0.general:0.extension:0.topic:").append(Integer.toString(i)).append(".langstring:0");
				String value = getStringValue(key.toString());
				if (value != null) {
					insertToList(result, value);
				}
	...
	protected List getURLs() {
		...
		if (num > 0) {
			...
			for (int i = 0; i < num; i++) {
				key.delete(0, key.length());
				key.append("record:0.technical:0.location:").append(Integer.toString(i));
				String value = getStringValue(key.toString());
				if (value != null) {
	...
	/**
	 * Retrieves the list of technical requirements for a resource from the current
	 * record.
	 *
	...
	protected List getTechnicalReqs() {
		/*
		 * The only difference from the string lists above is that object types require
		 * us to read/write more than one element's content.
		 */
		ArrayList result = new ArrayList();
		XMLNode parent = xmlRecord.getNode("record:0.technical:0");
		...
		if (num > 0) {
			...
			for (int i = 0; i < num; i++) {
				...
				typenamekey.append("record:0.technical:0.requirements:").append(Integer.toString(i))
						.append(".typename:0");
				minversionkey.delete(0, minversionkey.length());
				minversionkey.append("record:0.technical:0.requirements:").append(Integer.toString(i))
	...
	/**
	 * Retrieves the list of learning resource types for a resource from the current
	 * record.
	 *
	 * @return <code>List</code> of <code>DleseRecord.ResourceType</code> objects.
	 */
	protected List getResourceTypes() {
		...
		if (num > 0) {
			...
			for (int i = 0; i < num; i++) {
				...
				langkey.append("record:0.educational:0.learningresourcetype:").append(Integer.toString(i))
						.append(".langstring:0");

				String lang = getStringValue(langkey.toString());
				nodekey.delete(0, nodekey.length());
				nodekey.append("record:0.educational:0.learningresourcetype:").append(Integer.toString(i))
				...
				typekey.append("record:0.educational:0.learningresourcetype:").append(Integer.toString(i))
						.append(".extension:0.category:0.").append(cat).append(":0.langstring:0");
	...
	protected List getMetametadataContributors() {
		...
		if (num > 0) {
			...
			for (int i = 0; i < num; i++) {
				...
				rolekey.append("record:0.metametadata:0.contribute:").append(Integer.toString(i))
						.append(".role:0.langstring:0");
				titlekey.delete(0, titlekey.length());
				titlekey.append("record:0.metametadata:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.nametitle:0");
				firstnamekey.delete(0, firstnamekey.length());
				firstnamekey.append("record:0.metametadata:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.firstname:0");
				mikey.delete(0, mikey.length());
				mikey.append("record:0.metametadata:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.mi:0");
				lastnamekey.delete(0, lastnamekey.length());
				lastnamekey.append("record:0.metametadata:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.lastname:0");
				orgkey.delete(0, orgkey.length());
				orgkey.append("record:0.metametadata:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.org:0");
				addresskey.delete(0, addresskey.length());
				addresskey.append("record:0.metametadata:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.adr:0");
				citykey.delete(0, citykey.length());
				citykey.append("record:0.metametadata:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.city:0");
				statekey.delete(0, statekey.length());
				statekey.append("record:0.metametadata:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.state:0");
				zipkey.delete(0, zipkey.length());
				zipkey.append("record:0.metametadata:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.zip:0");
				countrykey.delete(0, countrykey.length());
				countrykey.append("record:0.metametadata:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.country:0");
				phonekey.delete(0, phonekey.length());
				phonekey.append("record:0.metametadata:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.tel:0");
				faxkey.delete(0, faxkey.length());
				faxkey.append("record:0.metametadata:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.fax:0");
				emailkey.delete(0, emailkey.length());
				emailkey.append("record:0.metametadata:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.email:0");
				homepagekey.delete(0, homepagekey.length());
				homepagekey.append("record:0.metametadata:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.url:0");
				datekey.delete(0, datekey.length());
				datekey.append("record:0.metametadata:0.contribute:").append(Integer.toString(i))
	...
	protected List getLifecycleContributors() {
		...
		if (num > 0) {
			...
			for (int i = 0; i < num; i++) {
				rolekey.delete(0, rolekey.length());
				rolekey.append("record:0.lifecycle:0.contribute:").append(Integer.toString(i))
						.append(".role:0.langstring:0");
				titlekey.delete(0, titlekey.length());
				titlekey.append("record:0.lifecycle:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.nametitle:0");
				firstnamekey.delete(0, firstnamekey.length());
				firstnamekey.append("record:0.lifecycle:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.firstname:0");
				mikey.delete(0, mikey.length());
				mikey.append("record:0.lifecycle:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.mi:0");
				lastnamekey.delete(0, lastnamekey.length());
				lastnamekey.append("record:0.lifecycle:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.lastname:0");
				orgkey.delete(0, orgkey.length());
				orgkey.append("record:0.lifecycle:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.org:0");
				addresskey.delete(0, addresskey.length());
				addresskey.append("record:0.lifecycle:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.adr:0");
				citykey.delete(0, citykey.length());
				citykey.append("record:0.lifecycle:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.city:0");
				statekey.delete(0, statekey.length());
				statekey.append("record:0.lifecycle:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.state:0");
				zipkey.delete(0, zipkey.length());
				zipkey.append("record:0.lifecycle:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.zip:0");
				countrykey.delete(0, countrykey.length());
				countrykey.append("record:0.lifecycle:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.country:0");
				phonekey.delete(0, phonekey.length());
				phonekey.append("record:0.lifecycle:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.tel:0");
				faxkey.delete(0, faxkey.length());
				faxkey.append("record:0.lifecycle:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.fax:0");
				emailkey.delete(0, emailkey.length());
				emailkey.append("record:0.lifecycle:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.email:0");
				homepagekey.delete(0, homepagekey.length());
				homepagekey.append("record:0.lifecycle:0.contribute:").append(Integer.toString(i))
						.append(".centity:0.extension:0.url:0");
				datekey.delete(0, datekey.length());
				datekey.append("record:0.lifecycle:0.contribute:").append(Integer.toString(i))
						.append(".date:0.datetime:0");
	...
	protected List getAnnotations() {
		...
		if (num > 0) {
			...
			for (int i = 0; i < num; i++) {
				titlekey.delete(0, titlekey.length());
				titlekey.append("record:0.annotation:").append(Integer.toString(i))
						.append(".centity:0.extension:0.nametitle:0");
				firstnamekey.delete(0, firstnamekey.length());
				firstnamekey.append("record:0.annotation:").append(Integer.toString(i))
						.append(".centity:0.extension:0.firstname:0");
				mikey.delete(0, mikey.length());
				mikey.append("record:0.annotation:").append(Integer.toString(i)).append(".centity:0.extension:0.mi:0");
				lastnamekey.delete(0, lastnamekey.length());
				lastnamekey.append("record:0.annotation:").append(Integer.toString(i))
						.append(".centity:0.extension:0.lastname:0");
				orgkey.delete(0, orgkey.length());
				orgkey.append("record:0.annotation:").append(Integer.toString(i))
						.append(".centity:0.extension:0.org:0");
				addresskey.delete(0, addresskey.length());
				addresskey.append("record:0.annotation:").append(Integer.toString(i))
						.append(".centity:0.extension:0.adr:0");
				citykey.delete(0, citykey.length());
				citykey.append("record:0.annotation:").append(Integer.toString(i))
						.append(".centity:0.extension:0.city:0");
				statekey.delete(0, statekey.length());
				statekey.append("record:0.annotation:").append(Integer.toString(i))
						.append(".centity:0.extension:0.state:0");
				zipkey.delete(0, zipkey.length());
				zipkey.append("record:0.annotation:").append(Integer.toString(i))
						.append(".centity:0.extension:0.zip:0");
				countrykey.delete(0, countrykey.length());
				countrykey.append("record:0.annotation:").append(Integer.toString(i))
						.append(".centity:0.extension:0.country:0");
				phonekey.delete(0, phonekey.length());
				phonekey.append("record:0.annotation:").append(Integer.toString(i))
						.append(".centity:0.extension:0.tel:0");
				faxkey.delete(0, faxkey.length());
				faxkey.append("record:0.annotation:").append(Integer.toString(i))
						.append(".centity:0.extension:0.fax:0");
				emailkey.delete(0, emailkey.length());
				emailkey.append("record:0.annotation:").append(Integer.toString(i))
						.append(".centity:0.extension:0.email:0");
				homepagekey.delete(0, homepagekey.length());
				homepagekey.append("record:0.annotation:").append(Integer.toString(i))
						.append(".centity:0.extension:0.url:0");
				datekey.delete(0, datekey.length());
				datekey.append("record:0.annotation:").append(Integer.toString(i)).append(".date:0.datetime:0");
				descriptionkey.delete(0, descriptionkey.length());
				descriptionkey.append("record:0.annotation:").append(Integer.toString(i))
	...
	protected List getRelations() {
		...
		if (num > 0) {
			...
			for (int i = 0; i < num; i++) {
				...
				kindkey.append("record:0.relation:").append(Integer.toString(i)).append(".kind:0.langstring:0");
				recordIDkey.delete(0, recordIDkey.length());
				recordIDkey.append("record:0.relation:").append(Integer.toString(i))
						.append(".resource:0.extension:0.catalogentry:0.entry:0.langstring:0");
				titlekey.delete(0, titlekey.length());
				titlekey.append("record:0.relation:").append(Integer.toString(i))
						.append(".resource:0.description:0.langstring:0");
				urlkey.delete(0, urlkey.length());
				urlkey.append("record:0.relation:").append(Integer.toString(i))
	...
	protected List getKeywords() {
		...
		if (num > 0) {
			...
			for (int i = 0; i < num; i++) {
				key.delete(0, key.length());
				key.append("record:0.general:0.keywords:").append(Integer.toString(i)).append(".langstring:0");
				String value = getStringValue(key.toString());
				if (value != null) {
					// CatalogTools.insertToList(result, value);
					result.add(value);
	 ...
	 * @param key
	 *            The path for the desired node.
	 * @return The text content of the XML node, or an empty string if the node does
	 *         not exist.
	 */
	 ...
	 *
	 * @param list
	 *            <code>List</code> to add an item to.
	 * @param s
	 *            <code>String</code> to add to the list.
	 */
	 ...
	 *            <code>List</code> to add an item to.
	 * @param o
	 *            <code>Object</code> to add to the list.
	 */
