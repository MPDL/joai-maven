...
/**
 * Converts from ADN format to a localized ADN format, which contains no
 * namespace declarations. Localized XML may be accessed using XPath notation
 * without the local-name() function, making it easier to use.
 *
