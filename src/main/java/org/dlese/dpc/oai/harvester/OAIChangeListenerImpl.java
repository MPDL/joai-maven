...
/**
 * Simple implementation of the OAIChangeListener interface that just prints
 * messages to System out.
 *
 * @author John Weatherley
 */
public class OAIChangeListenerImpl implements OAIChangeListener {

	/**
	 * This method is called whenever an OAI record file is deleted.
	 *
	 * @param recordFilePath
	 *            The record file absolute path
	 * @param identifier
	 *            The OAI identifier
	 */
	public void onRecordDelete(final String recordFilePath, final String identifier) {
		prtln("onRecordDelete(): recordFilePath='" + recordFilePath + "' identifier='" + identifier + "'");
	}
	...
	public void onRecordCreate(final String recordFilePath, final String identifier) {
		prtln("onRecordCreate(): recordFilePath='" + recordFilePath + "' identifier='" + identifier + "'");
	}
	...
	public void onRecordChange(final String recordFilePath, final String identifier) {
		prtln("onRecordChange(): recordFilePath='" + recordFilePath + "' identifier='" + identifier + "'");
	}

	/**
	 * This method is called whenever an OAI record file previously exists but has
	 * not changed.
	 *
	 * @param recordFilePath
	 *            The record file absolute path
	...
	public void onRecordExistsNoChange(final String recordFilePath, final String identifier) {
		prtln("onRecordExistsNoChange(): recordFilePath='" + recordFilePath + "' identifier='" + identifier + "'");
	}
