 ...
 * 
 * @version $Id: HarvesterAdminForm.java,v 1.20.2.3 2012/10/05 23:48:57 jweather
 *          Exp $
 * 
...
public final class HarvesterAdminForm extends ActionForm {
	 ...
	 * called before the properties are
	 * 
	 * repopulated by the controller.
	 * <p>
	 *
	 * 
	 * 
	 * The default implementation does nothing. In practice, the only properties
	 * that need to be reset are those
	 * 
	 * which represent checkboxes on a session-scoped form. Otherwise, properties
	 * can be given initial values
	 * 
	 ...
	 * 
	 * @param shDontZipFiles
	 *            The value to assign shDontZipFiles.
	 */
	 ...
	 * 
	 * @param val
	 *            The new shRepositoryName value
	 * 
	 */
	 ...
	 * 
	 * @param sh
	 *            The new lastOneTimeHarvest value
	 * 
	 */
	 ...
	 * 
	 * @param val
	 *            The new shMetadataPrefix value
	 * 
	 */
	 ...
	 * 
	 * @param val
	 *            The new shHarvestingInterval value
	 * 
	 */
	...
	/**
	 * 
	 * Gets the shIntervalGranularityLabel attribute of the HarvesterAdminForm
	 * object
	 *
	 * 
	 * 
	 ...
	 * 
	 * @param val
	 *            The new shIntervalGranularity value
	 * 
	 */
	 ...
	 * 
	 * @param val
	 *            The new shEnabledDisabled value
	 * 
	 */
	 ...
	 * 
	 * @param val
	 *            The new shHarvestedDataDir value
	 * 
	 */
	...
	/**
	 * 
	 * Gets the shIntervalGranularityListLabels attribute of the HarvesterAdminForm
	 * object
	 *
	 * 
	 * 
	 ...
	 * 
	 * @param val
	 *            The new harvestedDataDir value
	 * 
	 */
	 ...
	 * 
	 * 
	 * @param scheduledHarvests
	 *            The new scheduledHarvests value
	 * 
	 */
		...
		try {
			...
			if (param != null && param.equals("save")) {
				...
				if (getShEnabledDisabled().equalsIgnoreCase("enabled")) {
					...
					if (shIntervalGranularity.equals("days")
							&& (shRunAtTime == null || shRunAtTime.trim().length() == 0)) {
