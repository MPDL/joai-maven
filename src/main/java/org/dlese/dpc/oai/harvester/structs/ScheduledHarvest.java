...
/**
 * Data structure that holds the info needed to configure a regular-occuring
 * harvest of a particular repository.
 *
 * @author John Weatherley
 * @version $Id: ScheduledHarvest.java,v 1.20.2.1 2012/09/28 23:53:50 jweather
 *          Exp $
...
public final class ScheduledHarvest implements Serializable, Comparable {
	 ...
	 * @param setSpec
	 *            setSpec to be harvested, or null for none.
	 * @param baseURL
	 *            BaseURL.
	 * @param metadataPrefix
	 *            MetadataPrefix.
	 * @param harvestingInterval
	 *            Interval for harvesting.
	 * @param intervalGranularity
	 *            Interval granularity.
	 * @param runAtTime
	 *            The time of day to begin the harvest in 24 hour time for example
	 *            23:15, or null to schedule immediately
	 * @param enabledDisabled
	 *            One of exactly enabled or disabled.
	 * @param harvestDir
	 ...
	 *            Description of the Parameter
	 * @param doZip
	 *            True to zip the resulting harvest
	 */
	public ScheduledHarvest(String repositoryName, String setSpec, String baseURL, String metadataPrefix,
			String harvestingInterval, String intervalGranularity, String runAtTime, String enabledDisabled,
			File harvestDir, boolean spl, boolean isZip, boolean def, boolean doZip, String dupAllow) {
	...
	/**
	 * Gets the time of day this scheduled harvest is set to run, for display, for
	 * example 1:00 PM.
	 *
	...
	public String getRunAtTimeDisplay() {
		try {
			if (runAtTime == null || runAtTime.trim().length() == 0)
				...
				return new SimpleDateFormat("h:mm a zzz")
						.format(ScheduledHarvestManager.getHarvestStartDate(runAtTime));
		} catch (Throwable t) {
	...
	/**
	 * Gets the time of day to begin the regular harvests in 24 hour time, for
	 * example 23:15.
	 *
	 * @return The hour and minute in 24 hour time, for example 23:15, or null to
	...
	/**
	 * Sets the time of day to begin the regular harvests, in 24 hour time for
	 * example 23:15.
	 *
	 * @param runAtTime
	 ...
	 *
	 * @param n
	 *            The new numHarvestedLast value
	 */
	 ...
	 *
	 * @param val
	 *            The new harvestingInterval value
	 */
	 ...
	 *
	 * @param val
	 *            The new intervalGranularity value
	 */
	...
	/**
	 * Provides a String representataion for this ScheduledHarvest. This method may
	 * be used for debugging to see what is in the ScheduledHarvest. This method is
	 * also used it the {@link #equals(Object)} method.
	 *
