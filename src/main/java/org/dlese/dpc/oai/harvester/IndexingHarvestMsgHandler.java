...
/**
 * 
 * A HarvestMessageHandler that writes harvest status messages to a
 * SimpleLuceneIndex.
 *
 * 
 * 
...
public class IndexingHarvestMsgHandler implements HarvestMessageHandler {
	 ...
	 *            The name of the repository, for indexing.
	 * 
	 * @param baseURL
	 *            Base URL to the harvested provider.
	 * 
	 * @param set
	 *            Set being harvested.
	 * 
	 * @param shUid
	 *            UID of the scheduled Harvest.
	 * 
	 * @param numRecordsForNotification
	...
	/**
	 * 
	 * A final report detailing the result of a successful harvest, which only
	 * occurs if no
	 * 
	 * errors have occured.
	 *
