...
/**
 * This class contains OAI argument constants that are used throughout the OAI
 * application.
 *
...
public final class OAIArgs {
	...
	public final static String[] ALL_VALID_OAI_ARGUMENTS = {VERB, IDENTIFIER, METADATA_PREFIX, FROM, UNTIL, SET,
			RESUMPTION_TOKEN};

	/**
	 * Map of all valid arguments. Both key and value contain the same argument
	 * String.
	 */
