...
import org.dlese.dpc.oai.odlsearchclient.action.form.OdlSearchForm;
import org.dlese.dpc.repository.RepositoryManager;
import org.dlese.dpc.xml.XMLConversionService;

/**
 * A Struts Action for performing DLESE ODL searches of remote data providers
 * that support DLESE ODL Search. See
 * <a href="http://www.dlese.org/oai/docs/index.html#odl">DLESE ODL search
	...
	public ActionForward handleWebLogSearchRequest(ActionMapping mapping, SimpleQueryForm form,
		...
		try {
			...
			if (request.getParameter("q") != null) {
				...
				if (resultDocs != null) {
					prtln("query: " + query + ". Num results: " + resultDocs.size());
					// Collections.sort(resultDocs, new LuceneFieldComparator("requestdate",
