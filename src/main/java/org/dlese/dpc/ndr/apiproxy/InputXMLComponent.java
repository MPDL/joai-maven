 ...
 * API Basics</a> in the NDR API Documentation.
 * <p>
 *
 * InputXMLComponents consist of "commands", which specify criteria that is used
 * for selection of, or assignment to NDR Objects. For example, the commands in
 * the "find" request are used to select objects from the NDR, while the
 * commands in the "addMetadata" request assign values to the Metadata object to
 * be created.
 * <p>
 *
