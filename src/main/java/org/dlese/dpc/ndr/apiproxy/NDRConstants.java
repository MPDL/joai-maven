...
public class NDRConstants {
	...
	static public final Namespace NCS_NAMESPACE = DocumentHelper.createNamespace("ncs", "http://ncs.nsdl.org");

	static public final Namespace DLESE_NAMESPACE = DocumentHelper.createNamespace("dlese", "http://dlese.org");

	static public final Namespace AUTH_NAMESPACE = DocumentHelper.createNamespace("auth",
			"http://ns.nsdl.org/ndr/auth#");

	static public final Namespace FEDORA_MODEL_NAMESPACE = DocumentHelper.createNamespace("fedora-model",
			"info:fedora/fedora-system:def/model#");

	static public final Namespace FEDORA_VIEW_NAMESPACE = DocumentHelper.createNamespace("fedora-view",
			"info:fedora/fedora-system:def/view#");

	static public final Namespace NSDL_NAMESPACE = DocumentHelper.createNamespace("nsdl",
			"http://ns.nsdl.org/api/relationships#");

	static public final Namespace OAI_NAMESPACE = DocumentHelper.createNamespace("oai", "http://ns.nsdl.org/ndr/oai#");

	static public final Namespace WIKI_NAMESPACE = DocumentHelper.createNamespace("wiki",
			"http://ns.nsdl.org/ndr/wiki#");

	static public final String NCS_FINAL_STATUS = "NCSFinalStatus";

	/**
	 * Convenience method to assign values to the three values required for signed
	 * request to NDR.
	 */
	...
	public enum NDRObjectType {
		/** TYPES and their XML tags **/
		AGGREGATOR("aggregator", "Aggregator"), AGENT("agent", "Agent"), RESOURCE("resource",
				"Resource"), METADATA("metadata", "Metadata"), METADATAPROVIDER("metadataProvider", "MetadataProvider");
		...
		public String getNdrResponseType() {
			return this.ndrResponseType;
		}
	};

	public enum SupportedCommand {
		ADD("add"), DELETE("delete"), REPLACE("replace"), // NOTE: replace should never be used explicitly!!
		FIND("match");
