...
public class NDRAPIProxy {
	 ...
	 * 
	 * @param _service
	 *            - the service ( usually the endpoint, FIND, GET, etc. )
	 */
	...
	/**
	 * Make the request to the NDR for executing the contents of the XML String
	 * representing an InputXML object. This method added to allow requests to be
	 * submitted with arbitrary XML (rather than actually created from in InfoXML
	 * object.
	 * 
	 * @param _input
	 *            - the inputXML object to execute
	 * @return
	 */
