...
/**
 * A Wrapper object for a NdrCollection as stored in the NDR independent of the
 * NCS (no readers for ncs_collect).
 * <p>
 * A Composite Reader that assembles information from NDR Object readers and
 * exposes information on the collection level. Currently only provides
 * information from - Aggregator - MetadataProvider
 *
 * 
