 ...
 * relationships of NDR Aggregator Objects.
 * <p>
 *
 * More Info:
 * <li>Aggregator overview:
 * http://wiki.nsdl.org/index.php/Community:NDR/ObjectTypes#Aggregator
 *
 * <li>Aggregator data model:
 * http://wiki.nsdl.org/index.php/Community:NCore/Model/Objects/Aggregator
 *
 * <li>Aggregator API requests:
 * http://wiki.nsdl.org/index.php/Community:NDR/APIRequestsByObject#Aggregator_requests
 *
 * @author ostwald
 */
public class AggregatorReader extends GroupingObjectReader {
	...
	public AggregatorReader(String handle) throws Exception {
		...
		if (getObjectType() != MYTYPE)
			throw new Exception(
					"Provided handle (" + handle + ") does not refer to a aggregator object (" + getObjectType() + ")");
	}
