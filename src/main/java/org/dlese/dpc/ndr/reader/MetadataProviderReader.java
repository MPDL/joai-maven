 ...
 * relationships of NDR MetadataProvider Objects.
 * <p>
 *
 * More Info:
 * <li>MetadataProvider overview:
 * http://wiki.nsdl.org/index.php/Community:NDR/ObjectTypes#MetadataProvider
 *
 * <li>MetadataProvider data model:
 * http://wiki.nsdl.org/index.php/Community:NCore/Model/Objects/MetadataProvider
 *
 * <li>MetadataProvider API requests:
 * http://wiki.nsdl.org/index.php/Community:NDR/APIRequestsByObject#MetadataProvider_requests
 *
 * @author ostwald
 */
public class MetadataProviderReader extends GroupingObjectReader {
	...
	public MetadataProviderReader(String handle) throws Exception {
		...
		if (getObjectType() != MYTYPE)
			throw new Exception("Provided handle (" + handle + ") does not refer to a metadataProvider object ("
					+ getObjectType() + ")");
	}
	...
	public MetadataProviderReader(Document ndrResponse) throws Exception {
		...
		if (getObjectType() != MYTYPE)
			throw new Exception(
					"Provided document does not refer to a metadataProvider object (" + getObjectType() + ")");
	}
	 ...
	 */
	/*
	 * protected List dataStreamsToExtract() { if (dsFormats == null) { dsFormats =
	 * super.dataStreamsToExtract(); dsFormats.add("collection_config"); } return
	 * dsFormats; }
	 */
	...
	/**
	 * Gets the collectionRecord (dlese_collect format) of the
	 * MetadataProviderReader object
	 *
	...
	/**
	 * Gets the metadataProviderFor attribute (an agent handle) of the
	 * MetadataProviderReader object
	 *
	...
	public HarvestInfoReader getHarvestInfo() {
		if (harvestInfo == null) {
			...
			try {
				...
				/*
				 * Document doc = NdrUtils.getNDRObjectDoc(url); harvestInfo =
	...
	/**
	 * Gets the handles of the inactive metadata objects of the
	 * MetadataProviderReader object
	 *
	...
	public List getInactiveItemHandles() throws Exception {
		/*
		 * if (inactiveItemHandles == null) { FindRequest request = new FindRequest();
		 ...
		 * inactiveItemHandles = request.getResultHandles(); } return
		 * inactiveItemHandles;
		 */
