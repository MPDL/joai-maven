 ...
 * relationships of NDR Agent Objects.
 * <p>
 *
 * More Info:
 * <li>Agent overview:
 * http://wiki.nsdl.org/index.php/Community:NDR/ObjectTypes#Agent
 *
 * <li>Agent data model:
 * http://wiki.nsdl.org/index.php/Community:NCore/Model/Objects/Agent
 *
 * <li>Agent API requests:
 * http://wiki.nsdl.org/index.php/Community:NDR/APIRequestsByObject#Agent_requests
 *
 * @author ostwald
 */
public class AgentReader extends NdrObjectReader {
	...
	protected void agentInit() throws Exception {
		if (getObjectType() != MYTYPE)
			throw new Exception(
					"Provided handle (" + handle + ") does not refer to an Agent object (" + getObjectType() + ")");
