...
/**
 * Servlet responsible for initializing the NDR proxy and placing it in the
 * servlet Context.
 *
...
public final class NDRServlet extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		try {
			...
			/*
			 * servletContext.setAttribute ("ndrServer", ndrServer); prtln
			 * ("ndrServer set as context attribute - " + ndrServer);
			 */
			...
			NDRConstants.setMasterAgent((String) servletContext.getInitParameter("ndrMasterAgent"));
			NDRConstants.setMasterCollection((String) servletContext.getInitParameter("ndrMasterCollection"));
