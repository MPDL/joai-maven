...
import org.dlese.dpc.ndr.apiproxy.InputXML;
import org.dlese.dpc.ndr.apiproxy.InputXMLComponent;
 ...
 * {@link org.dlese.dpc.ndr.connection.NDRConnection}. Builds the inputXML
 * parameter that is sent as part a POST request.
 *
...
public class NdrRequest extends SimpleNdrRequest {
	...
	/**
	 * Gets the component of specified type ("property", "data", "relationship" from
	 * the InfoXML instance, if it exists.
	 *
	 * @param type
	 *            NOT YET DOCUMENTED
	 * @return The component value
	 * @exception Exception
	 *                If inputXML does not exist or the specified type is unknown
	 */
	 ...
	 *
	 * @param type
	 *            command type ("property", "relationship", or "data")
	 * @param element
	 *            command represented as Element.
	 */
	 ...
	 *            The feature to be added to the Command attribute
	 * @param action
	 *            specifies command action ("delete", "add")
	 */
	 ...
	 *
	 * @param prop
	 *            The feature to be added to the NcsProperty attribute
	 * @param value
	 *            The feature to be added to the NcsProperty attribute
	 */
	 ...
	 *
	 * @param prop
	 *            The feature to be added to the NcsRelationshipCmd attribute
	 * @param value
	 *            The feature to be added to the NcsRelationshipCmd attribute
	 */
	 ...
	 *
	 * @param type
	 *            The feature to be added to the DleseCommand attribute
	 * @param prop
	 *            The feature to be added to the DleseCommand attribute
	 * @param value
	 *            The feature to be added to the DleseCommand attribute
	 ...
	 *
	 * @param namespace
	 *            The feature to be added to the QualifiedCommand attribute
	 * @param type
	 *            The feature to be added to the QualifiedCommand attribute
	 * @param prop
	 *            The feature to be added to the QualifiedCommand attribute
	 ...
	 *            The feature to be added to the QualifiedCommand attribute
	 */
	public void addQualifiedCommand(Namespace namespace, String type, String prop, String value) {
	 ...
	 *            The feature to be added to the QualifiedCommand attribute
	 */
	public void addQualifiedCommand(Namespace namespace, String type, String prop, String value, String action) {
	 ...
	 *
	 * @param format
	 *            format of the datastream
	 * @param content
	 *            datastream represented as Element
	 * @exception Exception
	 *                If inputXML does not exist or content element is null
	 */
	 ...
	 *
	 * @param format
	 *            The feature to be added to the DataStreamCmd attribute
	 * @param content
	 *            The feature to be added to the DataStreamCmd attribute
	 * @param action
	 *            The feature to be added to the DataStreamCmd attribute
	 ...
	 *
	 * @param state
	 *            The feature to be added to the StateCmd attribute
	 */
	 ...
	 *
	 * @param visibility
	 *            The feature to be added to the OaiVisibilityCmd attribute
	 */
	 ...
	 *
	 * @param content
	 *            The feature to be added to the ServiceDescriptionCmd attribute
	 * @param action
	 *            The feature to be added to the ServiceDescriptionCmd attribute
	 * @exception Exception
	 *                if inputXML does not exist
