 ...
 * @version $Id: AddAggregatorRequest.java,v 1.7 2009/03/20 23:33:53 jweather
 *          Exp $
 */
public class AddAggregatorRequest extends SignedNdrRequest {
	...
	/**
	 * Convenience constructor that initializes the aggregatorFor releationship with
	 * provided agentHandle.
	 *
	 * @param agentHandle
	 *            NOT YET DOCUMENTED
	 */
	 ...
	 * <p>
	 * This relationship is used to connect a Collection Aggregator with the
	 * Collection Resource.
	 *
