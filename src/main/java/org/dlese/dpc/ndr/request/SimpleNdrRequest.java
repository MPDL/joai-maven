 ...
 * {@link org.dlese.dpc.ndr.connection.NDRConnection} with no payload (url only
 * - no InputXML object).
 *
...
public class SimpleNdrRequest {
	...
	/**
	 * Instantiates and initializes an NDRConnection for communicating with the NDR
	 * server.
	 *
	 * @param path
	 *            NOT YET DOCUMENTED
