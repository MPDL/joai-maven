 ...
 * <ol>
 * <li>first get the MetadataProviderReader (which is the object type in the NDR
 * from which collection information is obtained.</li>
 ...
 * @version $Id: DleseAsUseCaseHelper.java,v 1.4 2007/12/04 20:24:15 ostwald Exp
 *          $
 */
public class DleseAsUseCaseHelper {
	 ...
	 * <p>
	 * Note: only DLESE collections (written by the NCS) can be found by their
	 * collection key.
	 *
	 * @param collection
	 *            DLESE collection kdy (e.g., "dcc")
