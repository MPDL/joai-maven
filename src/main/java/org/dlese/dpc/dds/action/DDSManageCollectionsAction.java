...
import org.dlese.dpc.dds.action.form.DDSManageCollectionsForm;
...
public final class DDSManageCollectionsAction extends Action {
	 ...
	 *                if a servlet exception occurs
	 */
	public ActionForward handleRecordStatusEditing(ActionMapping mapping, DDSManageCollectionsForm mf,
		...
		errors.add("message",
				new ActionError("generic.message", "editing record number " + request.getParameter("recs")));
