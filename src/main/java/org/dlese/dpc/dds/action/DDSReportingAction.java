...
import org.dlese.dpc.dds.action.form.DDSReportingForm;
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		try {
			...
			if (indexToUse != null && indexToUse.equalsIgnoreCase("webLogIndex")) {
				String webLogIndexDir = GeneralServletTools.getAbsolutePath(
						(String) servlet.getServletContext().getInitParameter("webLogIndexLocation"),
						servlet.getServletContext());
				if (webLogIndexDir != null) {
					// Make sure cleanup happens on the previous webLogIndex by calling
					// finalization.
					// System.gc();
