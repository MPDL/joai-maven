...
public final class HistogramForm extends ActionForm implements Serializable {
	...
	// keep track of which index version is represented by HistogramVocabNode
	// caching:
	 ...
	 *
	 * @param currentVocabName
	 *            The new currentVocabName value
	 */
	 ...
	 *
	 * @param currentVocabGroup
	 *            The new currentVocabGroup value
	 */
	 ...
	 *
	 * @param currentVocabFramework
	 *            The new currentVocabFramework value
	 */
	 ...
	 *
	 * @param collectionMetaName
	 *            The new collectionMetaName value
	 */
	...
	public String getCollectionTitle() {
		return vocab.getUiValueLabel("dlese_collect", servletContext.getInitParameter("metadataVocabAudience"),
	 ...
	 *
	 * @param hasCollectionSpecified
	 *            The new hasCollectionSpecified value
	 */
	 ...
	 * Sets the collection attribute of the HistogramForm object
	 *
	 * @param collectionDocReader
	 *            The new collectionResultDoc value
	 */
	...
	public ArrayList getVocabList() {
		...
		if (!currentVocabGroup.equals("")) {
			vocList = vocab.getVocabNodes(currentVocabFramework,
					servletContext.getInitParameter("metadataVocabAudience"),
					servletContext.getInitParameter("metadataVocabLanguage"), currentVocabName, currentVocabGroup);
		} else {
			vocList = vocab.getVocabNodes(currentVocabFramework,
					servletContext.getInitParameter("metadataVocabAudience"),
					servletContext.getInitParameter("metadataVocabLanguage"), currentVocabName);
		}
	...
	public ArrayList hasSubtotalsGreaterThanZero(ArrayList ret) {
		// Set hasSubtotalsGreaterThanZero property in sub-headers, and isLastInSublist
		// for all nodes:
	...
	public ArrayList getCollectionsVocab() {
		return vocab.getVocabNodes("dlese_collect", servletContext.getInitParameter("metadataVocabAudience"),
				servletContext.getInitParameter("metadataVocabLanguage"), "key");
	}
	 ...
	 *
	 * @param rm
	 *            The new repositoryManager value
	 */
