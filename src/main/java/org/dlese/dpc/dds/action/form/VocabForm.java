...
import org.dlese.dpc.vocab.VocabNodeTermsGroups;
...
public class VocabForm extends ActionForm implements Serializable {
	...
	/**
	 * Gets the current vocabulary term as a VocabNode, or if unavailable, an
	 * untranslated vocabulary term as a VocabNode, which simply echos the vocab ID
	 * in the id, name, label and labelabbrev fields.
	 *
	...
	/**
	 * True if there is a vocab entry for this field/value, false if not. If true,
	 * {@link #getVocabTerm} will return the translated vocabs, if false it will
	 * return the untranslated values.
	 *
	...
	/**
	 * Gets the current vocabulary term as a VocabNode, or null if no vocab entry
	 * for this field is available.
	 *
	 * @return The vocabTerm value
	...
	/**
	 * Gets an untranslated vocabulary term as a VocabNode, which simply echos the
	 * vocab ID in the id, name, label and labelabbrev fields.
	 *
	 * @return The vocabTerm value
	 */
