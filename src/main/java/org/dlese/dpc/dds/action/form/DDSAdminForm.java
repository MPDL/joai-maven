...
public final class DDSAdminForm extends ActionForm {
	...
	public String getLastSyncTime() {
		return "";
		/*
		 * long ut = fileIndexingService.getLastSyncTime(); if ( ut == 0 ) { return
		 * null; } else { return new SimpleDateFormat( "MMM d, yyyy 'at' h:mm:ss a zzz"
		 * ).format( new Date( ut ) ); }
		 */
	}
	 ...
	 */
	/*
	 * public String getLastIndexModifiedTimez() { if(index == null) return ""; long
	 * ut = index.getLastModifiedTime(); if ( ut == 0 || getNumRecords() == null ) {
	 * return null; } else { return new SimpleDateFormat(
	 * "MMM d, yyyy 'at' h:mm:ss a zzz" ).format( new Date( ut ) ); } }
	 */
	 ...
	 *
	 * @param bool
	 *            The new showVocabUpdates value
	 */
