...
/**
 * Structure that holds the results of a standard DDS text/field search. This
 * Object is returned by
 * {@link org.dlese.dpc.dds.action.DDSQueryAction#ddsStandardQuery} and is used
 * by {@link org.dlese.dpc.dds.action.DDSQueryAction} and
 * {@link org.dlese.dpc.services.dds.action.DDSServicesAction}.
 *
...
public final class DDSStandardSearchResult {
	 ...
	 *            The search results.
	 * @param forwardName
	 *            The name that describes which page to forward to to render the
	 *            results.
	 * @param exception
	 *            An Exception if one occured, or null
	 */
