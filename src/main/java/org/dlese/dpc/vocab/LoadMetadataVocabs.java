 ...
 * context attribute:
 * <h5>No database connection</h5> <tt>MetadataVocab vocab =
 *  new LoadMetadataVocabs().getVocabs(<br>
 *  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 *  "/devel/ryandear/dds_test_data/vocab/DLESE_Errors.xml",<br>
 *  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 *  "org.apache.xerces.parsers.SAXParser" );</tt>
 * <h5>Connected to an SQL database (for new encoded Id assignment and tracking
 * of label changes)</h5>
...
public class LoadMetadataVocabs implements org.xml.sax.ContentHandler {
	 ...
	 *
	 * @param configDir
	 *            Base dir of vocab XML files
	 * @param configFile
	 *            XML defining vocabs to be loaded
	 * @param xmlParserClass
	 *            SAX parser class, i.e. "org.apache.xerces.parsers.SAXParser"
	 * @param servletContext
	 *            The java servlet context in which to store the loaded vocabularies
	 * @param sqlDriver
	 *            Optional (can be NULL) driver class for SQL access, i.e.
	 *            "org.gjt.mm.mysql.Driver"
	 * @param sqlURL
	 *            Optional (can be NULL) URL to SQL access, i.e.
	 *            "jdbc:mysql://quake.dpc.ucar.edu:3306/DLESE_Systems"
	 * @param sqlUser
	 *            Optional (can be NULL) username for access to SQL tables
	 * @param sqlPassword
	 *            Optional (can be NULL) password for access to SQL tables
	 * @param vocabTextFile
	 *            Optional (can be NULL) file where vocabs get listed as text
	 *            strings (for use by log analysis/reporting)
	 */
	public LoadMetadataVocabs(String configDir, String configFile, String xmlParserClass, ServletContext servletContext,
			String sqlDriver, String sqlURL, String sqlUser, String sqlPassword, String vocabTextFile) {
	...
	public void load() {
		...
		try {
			...
			MetadataVocabTermsGroups vocab = new MetadataVocabTermsGroups(sqlDriver, sqlURL, sqlUser, sqlPassword,
					vocabTextFile);
