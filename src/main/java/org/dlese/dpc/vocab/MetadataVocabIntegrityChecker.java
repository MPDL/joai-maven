...
public class MetadataVocabIntegrityChecker {
	...
	private static String failFilename() {
		...
		return vocab.getFilenameOfFieldPath(menu.getAttribute("metaFormat"), menu.getAttribute("metaVersion"),
				menu.getAttribute("audience"), menu.getAttribute("language"), menu.getAttribute("path"));
	}
