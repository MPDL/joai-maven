	...
	public int doStartTag() throws JspException {
		try {
			...
			if (useMetaNames) {
				...
				pageContext.getOut().print(StringUtil.replace(vocab.getUiLabelOf(system, field, value, getAbbreviated),
						"||", "<br>", false));
			} else {
				...
				while (ind2 > -1) {
					outStr.append(
							vocab.getUiLabelOfSystemIds(system, field, value.substring(ind1, ind2), getAbbreviated)
									+ ", ");
					ind1 = ind2 + 1;
