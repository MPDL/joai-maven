...
public class MetadataVocabTag extends TagSupport {
	...
	/**
	 * Interface is a particular UI within a given system. All systems should define
	 * an interface named "descr" (description). If a different "view" is needed for
	 * a spot within the app, another interface (such as "banner") can be
	 * referenced, provided that the corresponding XML files are loaded
	 * successfully.
	 *
	 * @param interfce
	 ...
	 * Setting to "resourceType" would cause a return of ALL values within the
	 * "Resource type" vocabulary, whereas "resourceType:Visual" would return only
	 * those values within the "Visual" sub-group.
	 *
	 * @param group
	 *            The new group value
	 */
