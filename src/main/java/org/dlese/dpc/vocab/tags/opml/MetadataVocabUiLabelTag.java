		...
		try {
			if (value.equals("")) {
				pageContext.getOut().print(
						vocab.getUiFieldLabel(metaFormat, metaVersion, audience, language, field, getAbbreviated));
			} else {
				pageContext.getOut().print(vocab.getUiValueLabel(metaFormat, metaVersion, audience, language, field,
						value, getAbbreviated));
			}
		} catch (Exception e) {
