...
public class MetadataVocabCheckboxesTag extends MetadataVocabTag {
	...
	public int doStartTag() throws JspException {
		try {
			...
			MetadataVocabInputState inputState = (MetadataVocabInputState) pageContext.getSession()
					.getAttribute("MetadataVocabInputState");
			if (inputState == null) {
			...
			if (value != null) {
				...
				pageContext.getOut()
						.print(vocab.getVocabCheckboxes(system, subGroup, wrap, tdWidth, skipTopRow, inputState));
			}
