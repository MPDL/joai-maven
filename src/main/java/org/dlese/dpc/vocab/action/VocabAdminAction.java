					...
					if (vocab != null) {
						...
						if (msgs != null) {
							for (int i = 0; i < msgs.size(); i++) {
								vForm.setLoaderFeedback(vForm.getLoaderFeedback() + "<li>" + msgs.get(i) + "</li>");
								hasMessages = true;
							}
						}
						...
						if (err != null) {
							for (int i = 0; i < err.size(); i++) {
								vForm.setLoaderFeedback(vForm.getLoaderFeedback() + "<li>" + err.get(i) + "</li>");
								hasMessages = true;
							}
						}
						if (!hasMessages) {
							...
							vForm.setLoaderFeedback("<ul style='color: red;'>" + vForm.getLoaderFeedback() + "</ul>");
						}
