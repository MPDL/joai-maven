...
public class HistogramVocabNode {
	 ...
	 *
	 * @param total
	 *            The new largestTotalInThisGroup value
	 */
	 ...
	 * the total number displayed next to the percentage image bar). This can be set
	 * to 100 to eliminate that behavior, or adjusted for UIs that may need more
	 * space.
	 *
	 * @param perc
	...
	public String getLibraryTotal() {
		if (isCollection) {
			// This is a collections node, so let the histogram form know which collection
			// is
	 ...
	 * object
	 *
	 * @param hasSubtotalsGreaterThanZero
	 *            The new hasSubtotalsGreaterThanZero value
	 */
