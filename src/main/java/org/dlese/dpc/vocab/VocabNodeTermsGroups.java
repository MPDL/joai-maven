...
public class VocabNodeTermsGroups implements VocabNode, Serializable {
	...
	/**
	 * This is needed because Struts &lt;logic:equal&gt; compares strings that look
	 * like numbers without regard to leading 0s, and our ID convention causes
	 * matches between '05' and '005' to return true (they are "equal"). Solution:
	 * turn comparison into non-digit strings ('05Compare' vs. '005Compare') and
	 * then Struts will use alphabetical instead of numerical comparison.
	 *
