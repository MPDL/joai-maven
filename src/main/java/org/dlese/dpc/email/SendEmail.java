...
/**
 * Handles sending emails. See <a href=
...
public class SendEmail {
	 ...
	 *
	 * @param MAIL_TYPE
	 *            The mail type, for example 'mail.smtp.host'
	 * @param MAIL_SERVER
	 *            The mail server, for example 'localhost', 'my-mail-server'
	 */
	 ...
	 *                If error
	 */
	public void doSendEmail(String[] toAddresses, String fromAddress, String msgSubject, String msgBody)
	...
	/**
	 * Sends email to the given address(es). Does not throw Exception if error but
	 * prints error message to System.out.
	 *
	 * @param msgTo
	 *            To address(es)
	 * @param msgFrom
	...
	/**
	 * Sends email to the given address. Does not throw Exception if error but
	 * prints error message to System.out.
	 *
	 * @param msgTo
	 *            To address
