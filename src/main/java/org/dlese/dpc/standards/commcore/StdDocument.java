...
public class StdDocument {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * Standard root = stdDoc.getRootStandard(); if (root == null) throw new
		 * Exception ("root standard not found"); // prtln ("root: " + root.toString());
		 * prtln ("root: " + root.getItemText()); for (Iterator
		 * i=root.getChildren().iterator();i.hasNext();) { Standard std =
		 * (Standard)i.next(); prtln ("\t" + std.getItemText()); }
		 */
