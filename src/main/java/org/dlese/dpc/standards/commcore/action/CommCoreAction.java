...
public class CommCoreAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		try {
			...
			commCoreServiceHelper = (CommCoreServiceHelper) servlet.getServletContext()
					.getAttribute("commCoreServiceHelper");
	 ...
	 *                If error.
	 */
	protected ActionForward doServiceInfo(HttpServletRequest request, HttpServletResponse response, CommCoreForm ccForm,
	 ...
	 *                If error.
	 */
	protected ActionForward doGetStandard(HttpServletRequest request, HttpServletResponse response, CommCoreForm ccForm,
			ActionMapping mapping) throws Exception {
	 ...
	 *                If error.
	 */
	protected ActionForward doGetMappings(HttpServletRequest request, HttpServletResponse response, CommCoreForm ccForm,
			ActionMapping mapping) throws Exception {
