...
public class AsnTopics {
	 ...
	 * @exception Exception
	 *                if topicURL cannot be processed
	 */
	 ...
	 *
	 * @exception Exception
	 *                if topicURL can't be processed
	 */
	...
	public static void cacheTopicsDoc(String srcDir) throws Exception {
		...
		/*
		 * if (!cacheFile.canWrite()) throw new Exception ("Cant write to " +
		 * cacheFilePath);
		 */
	 ...
	 * http://purl.org/ASN/scheme/ASNTopic/behavioralStudies)
	 *
	 * @param purl
	 *            NOT YET DOCUMENTED
