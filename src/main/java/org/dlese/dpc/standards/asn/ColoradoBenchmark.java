...
public class ColoradoBenchmark extends AsnStandard {
	...
	public String getDescription() {
		...
		if (parentNum != null && myNum != null) {
			return parentNum + "." + myNum + ". " + getNonNumberText(baseText, level);
		}
		return baseText;
	}

	/**
	 * Extracts the number for this standard, using a regular expression determined
	 * by the standard's level
	 */
