...
/**
 * Wraps {@link AsnStatement} to expose object based hierarchy information, such
 * as "children" and "ancestors" as AsnStandards rather than ASN IDs, and to
 * expose resolved ASN purl-based Attributes as human-readable strings, such as
...
public class AsnStandard {
	 ...
	 *
	 * @param e
	 *            the element defining the AsnStandard
	 * @param asnDoc
	 *            the Document containing this standard
	 */
