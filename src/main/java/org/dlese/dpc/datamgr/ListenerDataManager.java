...
public abstract class ListenerDataManager {
	...
	/**
	 * Removes an existing data object iff the object is not locked. If the object
	 * is locked a LockNotAvailableException is thrown.
	 *
	 * After successful completion the object is removed from the DataManager and
	...
	/**
	 * Deletes an existing data object iff the object is not locked. If the object
	 * is locked a LockNotAvailableException is thrown. Similar to
	...
	/**
	 * Updates a new object of data iff the object is not locked. If the object is
	 * locked a LockNotAvailableException is thrown.
	 *
	 * @param oid
	 *            The unique identifier that references the data object to be
	 *            updated
	...
	/**
	 * Construct the DataEvent object and invoke the appropriate method of all the
	 * listeners to this DataManager.
	 *
	 * @param dataToAdd
	 *            The list of OIDs for data added to this manager
	 */
	 ...
	 *
	 * @param dataToChange
	 *            The list of OIDs for data changed by this manager
	 */
