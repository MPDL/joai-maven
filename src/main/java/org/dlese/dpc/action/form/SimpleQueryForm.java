 ...
 * with the {@link org.dlese.dpc.action.SimpleQueryAction} Struts Action class.
 *
...
public final class SimpleQueryForm extends ActionForm implements Serializable {
	 ...
	 *
	 * @param collectionLabels
	 *            The new collectionLabels value
	 */
	...
	/**
	 * Gets the OAI SetSpecs that have been selected by the user in the UI. For
	 * example 'dcc' 'comet'. For use with a Struts select tag that has multiple
	 * selection enabled.
	 *
