...
/**
 * Overall log manager. See {@link ClfLogger ClfLogger} and {@link DebugLogger
...
public class DleseLogManager {
	...
	public static ClfLogger getClfLogger(Level loggerLevel, // one of java.util.logging.Level.*
	...
	public static DebugLogger getDebugLogger(int outputType, // For now, always LOG_STD
			...
			String outfilename) // name of output file
			throws LogException {
		return DebugLogger.getDebugLogger(outputType, timeType, outputFormat, loggerLevel, appendFlag, outfilename);
