<?xml version="1.0" encoding="UTF-8" ?><%@ page contentType="text/xml; charset=UTF-8" %><jsp:useBean id="rf" class="org.dlese.dpc.repository.action.form.RepositoryForm" scope="request"/><%@ include file="../TagLibIncludes.jsp" %><%@ page import = "org.dlese.dpc.index.*" import = "org.dlese.dpc.index.reader.*" %>
